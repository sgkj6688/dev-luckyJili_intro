            ...
            function(t, e, n) {
                ...
                (function(t) { /* unused harmony export Store */
                    ...
                    p.state.get = function() {
                        ...
                        void 0 === n && (n = {}), "string" == typeof t && (t = [t]), this._modules.register(t, e), g(this, this.state, t, this._modules.get(t), n.preserveState),
                                    ...
                                    void 0 !== l && (s && t.subscribe((function(t, a) {
                                        ...
                                        if (n(t, f, c)) {
                                            var s = P(),
                                                u = i(t),
                                                d = "mutation " + t.type + s;
                                            $(l, d, e), l.log("%c prev state", "color: #9E9E9E; font-weight: bold", r(f)), l.log("%c mutation", "color: #03A9F4; font-weight: bold", u), l.log("%c next state", "color: #4CAF50; font-weight: bold", r(c)), I(l)
                                        }
                                        f = c
                            ...
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return c = e.$axios, u = e.store, l = e.route, f = e.app, d = e.$config, e.redirect, p = {}, // 動態導入所需模組
                                        t.next = 4, Promise.resolve().then(n.t.bind(null, 221, 7));
                                case 4:
                                    return v = t.sent, h = v.default, t.next = 8, Promise.all( /* import() */ [n.e(1), n.e(0), n.e(2)]).then(n.bind(null, 252));
                                case 8:
                                    m = t.sent, g = m.isArray, y = m.isObject, // 需要連線自簽憑證時才需要，目前都直接連測試機，固不需要
                    ...
                    f.onRequest((function(t) {
                        ...
                        d.getHistoryRecord = function(t) {
                            ...
                            return s && (O.RoundIndex = s), u && (O.LogIndex = u), o && (O.Date = o, O.TimeZoneOffsetMinutes = c()().utcOffset()), i && (O.Minutes = i),
                                ...
                                // }
                                null != g && (O.OffsetStartTime = g), null != _ && (O.OffsetStartRowIndex = _), null != w && (O.OffsetDbIndex = w), f.get("/history/".concat(e, "/get-history-record"), {
                                    params: O
                                }).then((function(t) {
                        ...
                        d.getGoHistoryRecord = function(t) {
                            ...
                            return s && (O.RoundIndex = s), u && (O.LogIndex = u), o && (O.Date = o, O.TimeZoneOffsetMinutes = c()().utcOffset()), i && (O.Minutes = i),
                                ...
                                //   sendData.CreateTime = store.state.detailCreateTime
                                // }
                                null != g && (O.OffsetStartTime = g), null != _ && (O.OffsetStartRowIndex = _), null != w && (O.OffsetDbIndex = w), f.get("/v2/history/".concat(e, "/get-history-record"), {
                                    params: O
                                }).then((function(t) {
                                    return null == t ? [] : t.map((function(t) {
                                        var e = a.$utils.merge({}, t);
                        ...
                        return regeneratorRuntime.wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 5:
                                    ...
                                    return r.commit("cookies/SET_GAME_TOKEN", a.token), t.next = 18, Promise.all([
                                ...
                                case 18:
                                    ...
                                    break;
                                case 20:
                                    return t.next = 22, Promise.all([n.i18n.getRemoteLangMessage(n.i18n.locale), n.i18n.changeEelmentUiLocale(n.i18n.locale), r.dispatch("getGameSetting"),
                                        // store.dispatch('getGameGroup'),
                                        // store.dispatch('getUserApiInfo'),
                                        r.dispatch("getCurrencyDisplayList"), r.dispatch("GetSymbolStyleList")
                                    ]).catch((function(t) {
                                ...
                                case 22:
                                    ...
                                    a.posthost ? r.commit("control/setPostMessageHost", a.posthost) : r.commit("control/setPostMessageHost", ""),
                                        ...
                                        a.gp ? r.commit("control/setHideMemberPage", !0) : r.commit("control/setHideMemberPage", !1), a.sac && r.commit("cookies/SET_SAC", +a.sac);
                                case 25:
                                case "end":
                                    return t.stop()
                            }
                                ...
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return window.$nuxt.$loading.finish(),
                                            ...
                                            }), console.log("firstPageUrl on NuxtReady hook:", e.state.firstPageUrl), r = n.query.apiid || 0, o = r || e.getters.apiId, t.next = 9, e.dispatch("getSwitchOffInfo", o);
                                    case 9:
                                        // 禁止使用者縮放處理
                ...
                n.r(e),
                    ...
                    function(t, r) { /* harmony export (binding) */
                        ...
                        ***************************************************************************** */
                            ...
                            At = /** @class */ function() {
                                function t(t, e, n) {
                                    if (void 0 === e && (e = !1), void 0 === n && (n = !1), this.value = t, this.shallow = e, this.mock = n,
                                        // this.value = value
                                        this.dep = n ? Nt : new Ct, this.vmCount = 0, q(t, "__ob__", this), i(t)) {
                                        if (!n)
                                            if (Y) t.__proto__ = $t;
                         ...
                         */
                        function Lt(t, e, n) {
                            return t && S(t, "__ob__") && t.__ob__ instanceof At ? t.__ob__ : !Et || !n && st() || !i(t) && !p(t) || !Object.isExtensible(t) || t.__v_skip /* ReactiveFlags.SKIP */ || Yt(t) || t instanceof mt ? void 0 : new At(t, e, n)
                        }
                        /**
                        ...
                        function Mt(t, e, n) {
                            if (!Wt(t)) {
                                ...
                                return i(t) && h(e) ? (t.length = Math.max(t.length, e), t.splice(e, 1, n),
                                    ...
                                    r && !r.shallow && r.mock && Lt(n, !1, !0), n) : e in t && !(e in Object.prototype) ? (t[e] = n, n) : t._isVue || r && r.vmCount ? n : r ? (Rt(r.value, e, n, void 0, r.shallow, r.mock), r.dep.notify(), n) : (t[e] = n, n)
                            }
                        }
                        ...
                        function Se(t, e, n) {
                            ...
                            if (Yt(t) ? (f = function() {
                                    return t.value
                                }, h = Vt(t)) : Gt(t) ? (f = function() {
                                    return t.__ob__.dep.depend(), t
                                }, c = !0) : i(t) ? (m = !0, h = t.some((function(t) {
                                    return Gt(t) || Vt(t)
                                })), f = function() {
                        ...
                        function Ae(t, e, n, r, o, i) {
                            var c, u, l, f;
                            for (c in t) u = t[c], l = e[c], f = Te(c), a(u) || (a(l) ? (a(u.fns) && (u = t[c] = Ne(u, i)), s(f.once) && (u = t[c] = o(f.name, u, f.capture)), n(f.name, u, f.capture, f.passive, f.params)) : u !== l && (l.fns = u, t[c] = l));
                        ...
                        function Fe(t, e, n, r) {
                            ...
                            i ? (
                                // scoped slot
                                n = n || {}, r && (n = N(N({}, r), n)), o = i(n) || (l(e) ? e() : e)) : o = this.$slots[t] || (l(e) ? e() : e);
                            var a = n && n.slot;
                         ...
                         */
                        function Ue(t) {
                            return Kr(this.$options, "filters", t, !0) || M
                        }
                        ...
                        function tn(t) {
                            t._o = Je, t._n = _, t._s = g, t._l = Be, t._t = Fe, t._q = D, t._i = z, t._m = He, t._f = Ue, t._k = Ve, t._b = We, t._v = yt, t._e = gt, t._u = Ze, t._g = Ye, t._d = Xe, t._p = Qe
                        }
                        /**
                        ...
                        function On(t, e, n, r, o, a) {
                            return (i(n) || u(n)) && (o = r, r = n, n = void 0), s(a) && (o = wn),
                                function(t, e, n, r, o) {
                                    ...
                                    if ("string" == typeof e) {
                                        var u = void 0;
                                        s = t.$vnode && t.$vnode.ns || W.getTagNamespace(e), a = W.isReservedTag(e) ? new mt(W.parsePlatformTagName(e), n, r, void 0, void 0, t) : n && n.pre || !c(u = Kr(t.$options, "components", e)) ? new mt(e, n, r, void 0, void 0, t) : zr(u, n, t, r, e)
                                    } else
                        ...
                        ;
                            ...
                            var Ln = 1,
                                ...
                                Mn = document.createTextNode(String(Ln));
                            Rn.observe(Mn, {
                                characterData: !0
                            }), In = function() {
                                Ln = (Ln + 1) % 2, Mn.data = String(Ln)
                            }, Pn = !0
                        }
                        ...
                        function Dn(t, e) {
                            ...
                            if (En.push((function() {
                                ...
                                })), Tn || (Tn = !0, In()), !t && "undefined" != typeof Promise) return new Promise((function(t) {
                                n = t
                            }))
                        }
                        ...
                        if (Z && !Q) {
                            ...
                            $r && "function" == typeof $r.now && kr() > document.createEvent("Event").timeStamp && (
                        ...
                        var Mr = {
                                ...
                                insert: function(t) {
                                    ...
                                    r._isMounted || (r._isMounted = !0, _r(r, "mounted")), t.data.keepAlive && (n._isMounted ? (
                                        ...
                                        (e = r)._inactive = !1, wr.push(e)) : gr(r, !0 /* direct */ ))
                                },
                                destroy: function(t) {
                            ...
                            if (!a(t)) {
                                ...
                                if (f(t) && (t = l.extend(t)), "function" == typeof t) {
                                    ...
                                    if (s(t.options.functional)) return function(t, e, n, r, a) {
                                        ...
                                        if (i(p)) {
                                            for (var v = Me(p) || [], h = new Array(v.length), m = 0; m < v.length; m++) h[m] = Ar(v[m], n, d.parent, s);
                                            return h
                                        }
                                    }(t, p, e, n, r);
                        ...
                        function Gr(t, e, n) {
                            ...
                            for (var r, o, i, a = dt ? Reflect.ownKeys(e) : Object.keys(e), c = 0; c < a.length; c++)
                                ...
                                "__ob__" !== (r = a[c]) && (o = t[r], i = e[r], n && S(t, r) ? o !== i && p(o) && p(i) && Gr(o, i) : Mt(t, r, i));
                            return t
                        }
                        /**
                         * Data
                        ...
                        Ur.data = function(t, e, n) {
                             ...
                             * Other object hashes.
                             */
                            Ur.props = Ur.methods = Ur.inject = Ur.computed = function(t, e, n, r) {
                                if (!t) return e;
                            ...
                            if (l(e) && (
                                ...
                                function(t) {
                                    ...
                                    if (e) {
                                        var n, r, o = {};
                                        if (i(e))
                                            for (n = e.length; n--;) "string" == typeof(r = e[n]) && (o[k(r)] = {
                                                type: null
                                            });
                                        else if (p(e))
                                            for (var a in e) r = e[a], o[k(a)] = p(r) ? r : {
                                                type: r
                                            };
                                        t.props = o
                                    }
                        ...
                        function io(t, e, n) {
                            var r = !st();
                            l(n) ? (eo.get = r ? ao(e) : co(n), eo.set = L) : (eo.get = n.get ? r && !1 !== n.cache ? ao(e) : co(n.get) : L, eo.set = n.set || L), Object.defineProperty(t, e, eo)
                        }
                                        ...
                                        cacheVNode: function() {
                                            ...
                                            if (r) {
                                                ...
                                                e[o] = {
                                                    ...
                                                    // prune oldest entry
                                                    this.max && n.length > parseInt(this.max) && go(e, n[0], n, this._vnode), this.vnodeToCache = null
                                            }
                                        }
                                    },
                                    created: function() {
                        ...
                        ! function(t) {
                            ...
                            Object.defineProperty(t, "config", e),
                                ...
                                t.util = {
                                    ...
                                    mergeOptions: qr,
                                    defineReactive: Rt
                                }, t.set = Mt, t.delete = Dt, t.nextTick = Dn,
                                ...
                                t.options._base = t, N(t.options.components, _o),
                                function(t) {
                                    t.use = function(t) {
                        ...
                        var bo = b("style,class"),
                            ...
                            So = function(t, e) {
                                return Io(e) || "false" === e ? "false" : // allow arbitrary string value for contenteditable
                        ...
                        function ei(t, e) {
                            ...
                            if (!(c(n) && !1 === n.Ctor.options.inheritAttrs || a(t.data.attrs) && a(e.data.attrs))) {
                                ...
                                /* istanbul ignore if */
                                for (r in (Q || et) && l.value !== u.value && ni(i, "value", l.value), u) a(l[r]) && (ko(r) ? i.removeAttributeNS(jo, $o(r)) : Oo(r) || i.removeAttribute(r))
                            }
                        }
                        ...
                        function ni(t, e, n, r) {
                            r || t.tagName.indexOf("-") > -1 ? ri(t, e, n) : xo(e) ?
                                ...
                                Io(n) ? t.removeAttribute(e) : (
                                    ...
                                    n = "allowfullscreen" === e && "EMBED" === t.tagName ? "true" : e, t.setAttribute(e, n)) : Oo(e) ? t.setAttribute(e, So(e, n)) : ko(e) ? Io(n) ? t.removeAttributeNS(jo, $o(e)) : t.setAttributeNS(jo, e, n) : ri(t, e, n)
                        }
                        ...
                        function gi(t, e) {
                            if (!a(t.data.domProps) || !a(e.data.domProps)) {
                                ...
                                for (n in
                                    // clone observed objects, as the user probably wants to mutate it
                                    (c(u.__ob__) || s(u._v_attr_proxy)) && (u = e.data.domProps = N({}, u)), i) n in u || (o[n] = "");
                                for (n in u) {
                        ...
                        function Ii(t, e) {
                            ...
                            if (!(a(n.staticStyle) && a(n.style) && a(r.staticStyle) && a(r.style))) {
                                ...
                                var p = function(t, e) {
                                    var n, r = {};
                                    if (e)
                                        for (var o = t; o.componentInstance;)(o = o.componentInstance._vnode) && o.data && (n = wi(o.data)) && N(r, n);
                                    (n = wi(t.data)) && N(r, n);
                                    // @ts-expect-error parentNode.parent not VNodeWithData
                        ...
                        var Gi = Z ? window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout : /* istanbul ignore next */ function( /* istanbul ignore next */ t) {
                            return t()
                        };
                        ...
                        function Ki(t, e) {
                            ...
                            /* istanbul ignore if */
                            return e === Mi ? a > 0 && (n = Mi, l = a, f = i.length) : e === Di ? u > 0 && (n = Di, l = u, f = s.length) : f = (n = (l = Math.max(a, u)) > 0 ? a > u ? Mi : Di : null) ? n === Mi ? i.length : s.length : 0, {
                                type: n,
                                timeout: l,
                                propCount: f,
                                hasTransform: n === Mi && qi.test(r[zi + "Property"])
                            }
                        }
                        ...
                        function Xi(t, e) {
                            ...
                            /* istanbul ignore if */
                            {
                                for (var o = r.css, i = r.type, s = r.enterClass, u = r.enterToClass, d = r.enterActiveClass, p = r.appearClass, v = r.appearToClass, h = r.appearActiveClass, m = r.beforeEnter, g = r.enter, y = r.afterEnter, b = r.enterCancelled, w = r.beforeAppear, O = r.appear, C = r.afterAppear, S = r.appearCancelled, x = r.duration, j = vr, k = vr.$vnode
                                    ...
                                    ; k && k.parent;) j = k.context, k = k.parent;
                                ...
                                if (!$ || O || "" === O) {
                                    ...
                                    var M = !1 !== o && !tt,
                                        ...
                                        z = n._enterCb = B((function() {
                                            M && (Hi(n, E), Hi(n, P)),
                                                // @ts-expect-error
                                                z.cancelled ? (M && Hi(n, I), L && L(n)) : A && A(n), n._enterCb = null
                                        }));
                                    t.data.show ||
                                        ...
                                        T && T(n), M && (Wi(n, I), Wi(n, P), Vi((function() {
                                            Hi(n, I),
                                                // @ts-expect-error
                                                z.cancelled || (Wi(n, E), D || (ta(R) ? setTimeout(z, R) : Ji(n, i, z)))
                                        }))), t.data.show && (e && e(), N && N(n, z)), M || D || z()
                                }
                            }
                        }
                            ...
                            function d(t, e, n, o, i, a, u) { // for transition enter check
                                if (c(t.elm) && c(a) && (
                                    ...
                                    var f = t.data,
                                        d = t.children,
                                        m = t.tag;
                                    c(m) ? (t.elm = t.ns ? l.createElementNS(t.ns, m) : l.createElement(m, t), y(t), h(t, d, e), c(f) && g(t, e), v(n, t.elm, o)) : s(t.isComment) ? (t.elm = l.createComment(t.text), v(n, t.elm, o)) : (t.elm = l.createTextNode(t.text), v(n, t.elm, o))
                                }
                            }

                            function p(t, e) {
                                c(t.data.pendingInsert) && (e.push.apply(e, t.data.pendingInsert), t.data.pendingInsert = null), t.elm = t.componentInstance.$el, m(t) ? (g(t, e), y(t)) : (
                                ...
                                if (t !== e) {
                                    ...
                                    if (s(t.isAsyncPlaceholder)) c(e.asyncFactory.resolved) ? $(t.elm, e, n) : e.isAsyncPlaceholder = !0;
                                        ...
                                        if (s(e.isStatic) && s(t.isStatic) && e.key === t.key && (s(e.isCloned) || s(e.isOnce))) e.componentInstance = t.componentInstance;
                                            ...
                                            a(e.text) ? c(h) && c(g) ? h !== g && function(t, e, n, r, o) {
                                                var i, s, u, f = 0,
                                                    p = 0,
                                                    v = e.length - 1,
                                                    h = e[0],
                                                    ...
                                                    b = n[g],
                                                    w = !o;
                                                for (; f <= v && p <= g;) a(h) ? h = e[++f] : a(m) ? m = e[--v] : Ho(h, y) ? (x(h, y, r, n, p), h = e[++f], y = n[++p]) : Ho(m, b) ? (x(m, b, r, n, g), m = e[--v], b = n[--g]) : Ho(h, b) ? (
                                                    // Vnode moved right
                                            ...
                                            }(f, h, g, n, u) : c(g) ? (c(t.text) && l.setTextContent(f, ""), _(f, null, g, 0, g.length - 1, n)) : c(h) ? O(h, 0, h.length - 1) : c(t.text) && l.setTextContent(f, "") : t.text !== e.text && l.setTextContent(f, e.text), c(v) && c(p = v.hook) && c(p = p.postpatch) && p(t, e)
                                        }
                                }
                            }
                                                    ...
                                                    if (g.elm = e.elm, y) {
                                                        ...
                                                        if (C.merged)
                                                            for (
                                                                ...
                                                                var S = C.fns.slice(1), k = 0; k < S.length; k++) S[k]()
                                                    } else Uo(g);
                                                    g = g.parent
                                                }
                                            // destroy old node
                        ...
                        var oa = {
                            inserted: function(t, e, n, r) {
                                "select" === n.tag ? (
                                    // #6903
                                    r.elm && !r.elm._vOptions ? Le(n, "postpatch", (function() {
                        ...
                        function aa(t, e, n) {
                            ...
                            if (!o || Array.isArray(r)) {
                                for (var i, a, c = 0, s = t.options.length; c < s; c++)
                                    ...
                                    else if (D(sa(a), r)) return void(t.selectedIndex !== c && (t.selectedIndex = c));
                                o || (t.selectedIndex = -1)
                            }
                        }
                                    ...
                                    /* istanbul ignore if */
                                    {
                                        ...
                                        if (
                                            ...
                                            if ("in-out" === r) {
                                                ...
                                                Le(c, "afterEnter", p), Le(c, "enterCancelled", p), Le(f, "delayLeave", (function(t) {
                                                    d = t
                                                }))
                                            }
                                        }
                        ...
                        var Ca = {
                            ...
                            render: function(t) {
                                for (var e = this.tag || this.$vnode.data.tag || "span", n = Object.create(null), r = this.prevChildren = this.children, o = this.$slots.default || [], i = this.children = [], a = ga(this), c = 0; c < o.length; c++) {
                                    if ((l = o[c]).tag)
                        ...
                        fo.config.mustUseProp = function(t, e, n) {
                            ...
                            }, fo.config.isReservedTag = Mo, fo.config.isReservedAttr = bo, fo.config.getTagNamespace = function(t) {
                                return Ro(t) ? "svg" :
                            ...
                            fo.prototype.$mount = function(t, e) {
                                return function(t, e, n) {
                                    ...
                                    t.$el = e, t.$options.render || (
                                            ...
                                            t.$options.render = gt), _r(t, "beforeMount"), r = function() {
        ...
        62:
            ...
            function(t, e, n) {
                ...
                var r = n(4),
                    o = n(15),
                    i = n(13),
                    a = (n(36), n(22), n(21), n(27), n(14), n(54), n(93), n(43), n(16), n(551), n(254), n(136), n(25), n(24), n(20), n(6), n(8), n(9), n(11), n(12), n(3)),
                    c = n(91),
                    s = n.n(c),
                    u = n(379),
                    l = n(181),
                ...
                e.b = function(t, e) {
                    ...
                    function I(t) {
                        ...
                        return i && (r = r.abs()), r.gte(1e12) && a.t ? (r = parseFloat(r.div(1e12).toFixed(e, 0)), o = "T") : r.gte(1e9) && a.b ? (r = parseFloat(r.div(1e9).toFixed(e, 0)), o = "B") : r.gte(1e6) && a.m ? (r = parseFloat(r.div(1e6).toFixed(e, 0)), o = "M") : r.gte(1e3) && a.k && (r = parseFloat(r.div(1e3).toFixed(e, 0)), o = "K"), i && (r *= -1), g(r.toString(), e) + o
                    }
                    /**
                     * 將數字無條件捨去至小數點第二位
                     * @param {Number} number
                    ...
                    var T = {
                        ...
                        getGameIconUrl: function(t, e, n) {
                                var o = e || 3,
                                    ...
                                    c = "",
                                    s = Object(f.a)(t);
                                return a.set("tx", ["zh-CN", "zh-TW", "vi-VN"]), a.set("lj", ["zh-CN", "zh-TW", "pt-BR"]), a.set("lj2", ["zh-CN", "zh-TW", "pt-BR"]), a.set("lt", ["zh-CN", "zh-TW", "pt-BR"]), a.set("lm", ["zh-CN", "zh-TW", "pt-BR"]), a.set("col", ["zh-CN", "zh-TW", "es-AR"]), a.set("clb", ["zh-CN", "zh-TW", "pt-BR", "tr-TR"]), (a.get(s) || ["zh-CN", "zh-TW"]).includes(n) && (i = n),
                                    // 處理品牌要顯示什麼
                        ...
                        getGameIconUrlBySymbolStyle:
                            ...
                            function(t, e, n, o) {
                                var i = e || 3,
                                    ...
                                    s = "",
                                    u = Object(f.a)(t);
                                return c.set("tx", ["zh-CN", "zh-TW", "vi-VN"]), c.set("lj", ["zh-CN", "zh-TW", "pt-BR"]), c.set("lj2", ["zh-CN", "zh-TW", "pt-BR"]), c.set("lt", ["zh-CN", "zh-TW", "pt-BR"]), c.set("lm", ["zh-CN", "zh-TW", "pt-BR"]), c.set("col", ["zh-CN", "zh-TW", "es-AR"]), c.set("clb", ["zh-CN", "zh-TW", "pt-BR", "tr-TR"]), (c.get(u) || ["zh-CN", "zh-TW"]).includes(n) && (a = n),
                                    // 處理品牌要顯示什麼
                        ...
                        getGameIconUrlByStyle: function(t, e, n, o) {
                            ...
                            return c.set("tx", ["zh-CN", "zh-TW", "vi-VN"]), c.set("lj", ["zh-CN", "zh-TW", "pt-BR"]), c.set("lj2", ["zh-CN", "zh-TW", "pt-BR"]), c.set("lt", ["zh-CN", "zh-TW", "pt-BR"]), c.set("lm", ["zh-CN", "zh-TW", "pt-BR"]), c.set("col", ["zh-CN", "zh-TW", "es-AR"]), c.set("clb", ["zh-CN", "zh-TW", "pt-BR", "tr-TR"]), (c.get(u) || ["zh-CN", "zh-TW"]).includes(n) && (a = n),
                                // 處理品牌要顯示什麼
                                "plinko" === u && ("tada" !== r.state.gameIconBrandFilename && 3 !== r.getters.apiId || (s = "_tada")), "/images/gamehistory/".concat(u, "/style-").concat(o, "/icon").concat(i, "/icon_").concat(a).concat(s, ".png")
                        },
