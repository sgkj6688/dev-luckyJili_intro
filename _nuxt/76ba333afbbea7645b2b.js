...
t.next=4,Promise.resolve().then(n.t.bind(null,221,7));case 4:return v=t.sent,h=v.default,t.next=8,Promise.all(/* import() */[n.e(1),n.e(0),n.e(2)]).then(n.bind(null,253));case 8:g=t.sent,m=g.isArray,y=g.isObject,// 需要連線自簽憑證時才需要，目前都直接連測試機，固不需要
...
"ko-KR":"ko",
// 'bn-IN': '',
"es-AR":"es","pt-BR":"pt","de-DE":"de","sv-SE":"sv-SE","it-IT":"it","nl-NL":"nl","ro-RO":"ro","da-DK":"da"},h=function(){var t=Object(r.a)(regeneratorRuntime.mark((function t(e){var r,o;return regeneratorRuntime.wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return r=v[e]||"en",t.next=3,n(683)("./"+r);case 3:o=t.sent,a.a.use(o.default);case 5:case"end":return t.stop()}}),t)})));return function(e){return t.apply(this,arguments)}}();
// 切換語系時執行更新
...
/* harmony import */n(691);r.default.use(i.a)},
/***/244:
/***/function(t,e,n){"use strict";
/* harmony import */n(55);
/* harmony import */var r=n(3);
...
// ssr mock dep
var Nt={notify:R,depend:R,addSub:R,removeSub:R},At=/** @class */function(){function t(t,e,n){if(void 0===e&&(e=!1),void 0===n&&(n=!1),this.value=t,this.shallow=e,this.mock=n,
// this.value = value
...
/**
             ...
             */
{var a=Object.keys(t);for(r=0;r<a.length;r++){var c;Lt(t,c=a[r],Pt,void 0,e,n)}}}
/**
 ...
 */
function Rt(t,e,n){return t&&S(t,"__ob__")&&t.__ob__ instanceof At?t.__ob__:!Et||!n&&st()||!i(t)&&!p(t)||!Object.isExtensible(t)||t.__v_skip/* ReactiveFlags.SKIP */||Yt(t)||t instanceof gt?void 0:new At(t,e,n)}
/**
 * Define a reactive property on an Object.
 */function Lt(t,e,n,r,o,a,c){void 0===c&&(c=!1);var s=new Ct,u=Object.getOwnPropertyDescriptor(t,e);if(!u||!1!==u.configurable){
...
return;if(!o&&Yt(r)&&!Yt(e))return void(r.value=e);n=e}d=o?e&&e.__ob__:Rt(e,!1,a),s.notify()}}}),s}}function Dt(t,e,n){if(!Wt(t)){var r=t.__ob__;return i(t)&&h(e)?(t.length=Math.max(t.length,e),t.splice(e,1,n),
// when mocking for SSR, array methods are not hijacked
r&&!r.shallow&&r.mock&&Rt(n,!1,!0),n):e in t&&!(e in Object.prototype)?(t[e]=n,n):t._isVue||r&&r.vmCount?n:r?(Lt(r.value,e,n,void 0,r.shallow,r.mock),r.dep.notify(),n):(t[e]=n,n)}}function Mt(t,e){if(i(t)&&h(e))t.splice(e,1);else{var n=t.__ob__;t._isVue||n&&n.vmCount||Wt(t)||S(t,e)&&(delete t[e],n&&n.dep.notify())}}
/**
...
if(!Wt(t)){Rt(t,e,st()/* ssr mock reactivity */);0}}function Gt(t){return Wt(t)?Gt(t.__v_raw):!(!t||!t.__ob__)}function Vt(t){return!(!t||!t.__v_isShallow)}function Wt(t){return!(!t||!t.__v_isReadonly)}function Ht(t){return Gt(t)||Wt(t)}function Jt(t){var e=t&&t.__v_raw;return e?Jt(e):t}function qt(t){
 ...
 */function de(t){return le(t,!0)}function pe(t,e){var n,r,o=l(t);o?(n=t,r=R):(n=t.get,r=t.set);var i=st()?null:new ur(pt,n,R,{lazy:!0});var a={
...
var we,Oe={};
// implementation
function Ce(t,e,n){return Se(t,e,n)}function Se(t,e,n){var r=void 0===n?o:n,a=r.immediate,c=r.deep,s=r.flush,u=void 0===s?"pre":s;r.onTrack,r.onTrigger;var f,d,p=pt,v=function(t,e,n){void 0===n&&(n=null);var r=jn(t,null,n,p,e);return c&&r&&r.__ob__&&r.__ob__.dep.depend(),r},h=!1,g=!1;if(Yt(t)?(f=function(){return t.value},h=Vt(t)):Gt(t)?(f=function(){return t.__ob__.dep.depend(),t},c=!0):i(t)?(g=!0,h=t.some((function(t){return Gt(t)||Vt(t)})),f=function(){return t.map((function(t){return Yt(t)?t.value:Gt(t)?(t.__ob__.dep.depend(),ir(t)):l(t)?v(t,ge):void 0}))}):
// getter with cb
f=l(t)?e?function(){return v(t,ge)}:function(){if(!p||!p._isDestroyed)return d&&d(),v(t,ve,[y])}:R,e&&c){var m=f;f=function(){return ir(m())}}var y=function(t){d=_.onStop=function(){v(t,me)}};
// in SSR there is no need to setup an actual effect, and it should be noop
// unless it's eager
if(st())
// we will also not call the invalidate callback (+ runner is not set up)
return y=R,e?a&&v(e,he,[f(),g?[]:void 0,y]):f(),R;var _=new ur(pt,f,R,{lazy:!0});_.noRecurse=!e;var b=g?[]:Oe;
...
r=o).fns.push(i):
// existing plain hook
r=Ne([o,i]),r.merged=!0,t[e]=r}function Le(t,e,n,r,o){if(c(e)){if(S(e,n))return t[n]=e[n],o||delete e[n],!0;if(S(e,r))return t[n]=e[r],o||delete e[r],!0}return!1}
...
function Qe(t,e){return"string"==typeof t?e+t:t}function tn(t){t._o=Je,t._n=_,t._s=m,t._l=Be,t._t=Fe,t._q=M,t._i=z,t._m=He,t._f=Ue,t._k=Ve,t._b=We,t._v=yt,t._e=mt,t._u=Ze,t._g=Ye,t._d=Xe,t._p=Qe}
/**
...
xt();try{if(e)for(var r=e;r=r.$parent;){var o=r.$options.errorCaptured;if(o)for(var i=0;i<o.length;i++)try{if(!1===o[i].call(r,t,e,n))return}catch(t){kn(t,r,"errorCaptured hook")}}kn(t,e,n)}finally{jt()}}function jn(t,e,n,r,o){var i;try{(i=n?t.apply(e,n):t.call(e))&&!i._isVue&&g(i)&&!i._handled&&(i.catch((function(t){return xn(t,r,o+" (Promise/async)")})),i._handled=!0)}catch(t){xn(t,r,o)}return i}function kn(t,e,n){if(W.errorHandler)try{return W.errorHandler.call(null,t,e,n)}catch(e){
...
nt&&setTimeout(R)},Pn=!0}else if(Q||"undefined"==typeof MutationObserver||!lt(MutationObserver)&&
...
var Rn=1,Ln=new MutationObserver(Nn),Dn=document.createTextNode(String(Rn));Ln.observe(Dn,{characterData:!0}),In=function(){Rn=(Rn+1)%2,Dn.data=String(Rn)},Pn=!0}function Mn(t,e){var n;
// $flow-disable-line
...
l(e)?this.getter=e:(this.getter=function(t){if(!K.test(t)){var e=t.split(".");return function(t){for(var n=0;n<e.length;n++){if(!t)return;t=t[e[n]]}return t}}}(e),this.getter||(this.getter=R)),this.value=this.lazy?void 0:this.get()}
/**
...
var i=_t(t);return i.fnContext=n,i.fnOptions=r,e.slot&&((i.data||(i.data={})).slot=e.slot),i}function Rr(t,e){for(var n in e)t[k(n)]=e[n]}function Lr(t){return t.name||t.__name||t._componentTag}
...
// component itself.
var n=e.options.props;if(!a(n)){var r={},o=t.attrs,i=t.props;if(c(o)||c(i))for(var s in n){var u=P(s);Le(r,i,s,u,!0)||Le(r,o,s,u,!1)}return r}}(e,t);
// functional component
// @ts-expect-error
if(s(t.options.functional))return function(t,e,n,r,a){var s=t.options,u={},l=s.props;if(c(l))for(var f in l)u[f]=Yr(f,l,e||o);else c(n.attrs)&&Rr(u,n.attrs),c(n.props)&&Rr(u,n.props);var d=new Nr(n,u,a,r,t),p=s.render.call(null,d._c,d);if(p instanceof gt)return Ar(p,n,d.parent,s);if(i(p)){for(var v=De(p)||[],h=new Array(v.length),g=0;g<v.length;g++)h[g]=Ar(v[g],n,d.parent,s);return h}}(t,p,e,n,r);
...
// @ts-expect-error
var m=Lr(t.options)||u;return new gt(
// @ts-expect-error
...
t(n,r),e(n,r)};return n._merged=!0,n}var Fr=R,Ur=W.optionMergeStrategies;
/**
...
var u=Et;Tt(!0),Rt(a),Tt(u)}return a}var Zr=/^\s*function (\w+)/;
/**
...
/* istanbul ignore else */Lt(r,i,a,void 0,!0/* shallow */),
...
var i=t._setupProxy={};for(var a in o)"__sfc"!==a&&re(i,o,a)}else for(var a in o)J(a)||re(t,o,a)}}(t),e.methods&&function(t,e){t.$options.props;for(var n in e)t[n]="function"!=typeof e[n]?R:E(e[n],t)}(t,e.methods),e.data)!function(t){var e=t.$options.data;e=t._data=l(e)?function(t,e){
...
/**
     * Class inheritance
     */t.extend=function(t){t=t||{};var n=this,r=n.cid,o=t._Ctor||(t._Ctor={});if(o[r])return o[r];var i=Lr(t)||Lr(n.options);var a=function(t){this._init(t)};return(a.prototype=Object.create(n.prototype)).constructor=a,a.cid=e++,a.options=qr(n.options,t),a.super=n,
...
// cache constructor
o[r]=a,a}}function vo(t){return t&&(Lr(t.Ctor.options)||t.tag)}function ho(t,e){return i(t)?t.indexOf(e)>-1:"string"==typeof t?t.split(",").indexOf(e)>-1:!!v(t)&&t.test(e)
...
var i=n&&n.data;
/* istanbul ignore else */Lt(t,"$attrs",i&&i.attrs||o,null,!0),Lt(t,"$listeners",e._parentListeners||o,null,!0)}(e),_r(e,"beforeCreate",void 0,!1/* setContext */),function(t){var e=Tr(t.$options.inject,t);e&&(Tt(!1),Object.keys(e).forEach((function(n){Lt(t,n,e[n])})),Tt(!0))}(e),// resolve injections before data/props
...
t.util={warn:Fr,extend:N,mergeOptions:qr,defineReactive:Lt},t.set=Dt,t.delete=Mt,t.nextTick=Mn,
// 2.6 explicit observable API
t.observable=function(t){return Rt(t),t},t.options=Object.create(null),G.forEach((function(e){t.options[e+"s"]=Object.create(null)})),
...
// new directive, bind
Qo(o,"bind",e,t),o.def&&o.def.inserted&&u.push(o));if(u.length){var f=function(){for(var n=0;n<u.length;n++)Qo(u[n],"inserted",e,t)};i?Re(e,"insert",f):f()}l.length&&Re(e,"postpatch",(function(){for(var n=0;n<l.length;n++)Qo(l[n],"componentUpdated",e,t)}));if(!i)for(n in c)s[n]||
...
var l=a(r)?"":String(r);yi(o,l)&&(o.value=l)}else if("innerHTML"===n&&Lo(o.tagName)&&a(o.innerHTML)){(
...
/* istanbul ignore else */
if("object"==typeof t){var e={};return!1!==t.css&&N(e,Ri(t.name||"v")),N(e,t),e}return"string"==typeof t?Ri(t):void 0}}var Ri=x((function(t){return{enterClass:"".concat(t,"-enter"),enterToClass:"".concat(t,"-enter-to"),enterActiveClass:"".concat(t,"-enter-active"),leaveClass:"".concat(t,"-leave"),leaveToClass:"".concat(t,"-leave-to"),leaveActiveClass:"".concat(t,"-leave-active")}})),Li=Z&&!tt,Di="transition",Mi="animation",zi="transition",Bi="transitionend",Fi="animation",Ui="animationend";Li&&(
/* istanbul ignore if */
...
/* istanbul ignore if */
{for(var o=r.css,i=r.type,s=r.enterClass,u=r.enterToClass,d=r.enterActiveClass,p=r.appearClass,v=r.appearToClass,h=r.appearActiveClass,g=r.beforeEnter,m=r.enter,y=r.afterEnter,b=r.enterCancelled,w=r.beforeAppear,O=r.appear,C=r.afterAppear,S=r.appearCancelled,x=r.duration,j=vr,k=vr.$vnode
// activeInstance will always be the <transition> component managing this
// transition. One edge case to check is when the <transition> is placed
// as the root node of a child component. In that case we need to check
// <transition>'s parent for appear check.
;k&&k.parent;)j=k.context,k=k.parent;var $=!j._isMounted||!t.isRootInsert;if(!$||O||""===O){var I=$&&p?p:s,P=$&&h?h:d,E=$&&v?v:u,T=$&&w||g,N=$&&l(O)?O:m,A=$&&C||y,R=$&&S||b,L=_(f(x)?x.enter:x);0;var D=!1!==o&&!tt,M=ea(N),z=n._enterCb=B((function(){D&&(Hi(n,E),Hi(n,P)),
// @ts-expect-error
z.cancelled?(D&&Hi(n,I),R&&R(n)):A&&A(n),n._enterCb=null}));t.data.show||
// remove pending leave element on enter by injecting an insert hook
Re(t,"insert",(function(){var e=n.parentNode,r=e&&e._pending&&e._pending[t.key];r&&r.tag===t.tag&&r.elm._leaveCb&&r.elm._leaveCb(),N&&N(n,z)})),
// start enter transition
T&&T(n),D&&(Wi(n,I),Wi(n,P),Vi((function(){Hi(n,I),
// @ts-expect-error
z.cancelled||(Wi(n,E),M||(ta(L)?setTimeout(z,L):Ji(n,i,z)))}))),t.data.show&&(e&&e(),N&&N(n,z)),D||M||z()}}}function Qi(t,e){var n=t.elm;
...
if(!l||f)return!1}else h(e,u,n);if(c(a)){var v=!1;for(var g in a)if(!k(g)){v=!0,m(e,n);break}!v&&a.class&&
...
var S=C.fns.slice(1),k=0;k<S.length;k++)S[k]()}else Uo(m);m=m.parent}
// destroy old node
...
// #6903
r.elm&&!r.elm._vOptions?Re(n,"postpatch",(function(){oa.componentUpdated(t,e,n)})):ia(t,e,n.context),t._vOptions=[].map.call(t.options,sa)):("textarea"===n.tag||zo(t.type))&&(t._vModifiers=e.modifiers,e.modifiers.lazy||(t.addEventListener("compositionstart",ua),t.addEventListener("compositionend",la),
...
return this._leaving=!0,Re(f,"afterLeave",(function(){e._leaving=!1,e.$forceUpdate()})),ya(t,o);if("in-out"===r){if(rn(i))return s;var d,p=function(){d()};Re(c,"afterEnter",p),Re(c,"enterCancelled",p),Re(f,"delayLeave",(function(t){d=t}))}}return o}
...
fo.config.mustUseProp=function(t,e,n){return"value"===n&&wo(t)&&"button"!==e||"selected"===n&&"option"===t||"checked"===n&&"input"===t||"muted"===n&&"video"===t},fo.config.isReservedTag=Do,fo.config.isReservedAttr=bo,fo.config.getTagNamespace=function(t){return Lo(t)?"svg":
...
/* harmony import */var r=n(4),o=n(15),i=n(13),a=(n(36),n(22),n(21),n(27),n(14),n(54),n(93),n(43),n(16),n(552),n(252),n(136),n(25),n(24),n(20),n(6),n(8),n(9),n(11),n(12),n(3)),c=n(91),s=n.n(c),u=n(379),l=n(181),f=n(41),d=n(135),p=n.n(d),v=n(88),h=n(177),g=n(53);
...
return e<0?(d="-",p=(e/c*-1).toString()):(d="",p=(e/c*1).toString()),i?a+"‎"+d+I(p,s):a+"‎"+d+m(p,s)}
/**
     * 取得貨幣顯示
     * @param {number} value 數值
     * @param {number} customApiId 自訂apiid不使用vuex中的apiid
...
// 廠商自定義樣式
if(null!=Object(g.c)(t,n,g.a))return"".concat(g.a,"-").concat(n);
// 節慶樣式
var o=e.festival;if(null!=Object(g.c)(t,o,g.b))return"".concat(g.b,"-").concat(o);
// 舊規格樣式
var a=e.symbolstyle||e.style||r.state.style.default;if(a){var c=parseInt(a,10),s=c>=100?g.a:g.b,u=s===g.a?(c/100).toString():a;if(null!=Object(g.c)(t,u,s))return"".concat(s,"-").concat(u)}return""}a.default.filter("commaFormat",(function(t){return m(t)})),
/*
   * 時間 Format
   */
...
/**
   ...
   * @param {string} number
   * @returns 格式化後字串
   */,screamingSnakeCase:_,formatNumberKM:function(t){var e=p()(t),n="";return e.gte(1e6)?(e=e.div(1e6),n="m"):e.gte(1e3)&&(e=e.div(1e3),n="k"),m(e.toString())+n},formatNumberKMBT:I,getCaseInsensitiveProperty:S,getItemCardi18nId:
/**
...
/***/},
/***/683:
/***/function(t,e,n){var r={"./af-ZA":[424,1,0,2],"./af-ZA.js":[424,1,0,2],"./ar":[425,1,0,2],"./ar.js":[425,1,0,2],"./bg":[426,1,0,2],"./bg.js":[426,1,0,2],"./ca":[427,1,0,2],"./ca.js":[427,1,0,2],"./cs-CZ":[428,1,0,2],"./cs-CZ.js":[428,1,0,2],"./da":[429,1,0,2],"./da.js":[429,1,0,2],"./de":[430,1,0,2],"./de.js":[430,1,0,2],"./ee":[431,1,0,2],"./ee.js":[431,1,0,2],"./el":[432,1,0,2],"./el.js":[432,1,0,2],"./en":[433,1,0,2],"./en.js":[433,1,0,2],"./eo":[434,1,0,2],"./eo.js":[434,1,0,2],"./es":[435,1,0,2],"./es.js":[435,1,0,2],"./eu":[436,1,0,2],"./eu.js":[436,1,0,2],"./fa":[437,1,0,2],"./fa.js":[437,1,0,2],"./fi":[438,1,0,2],"./fi.js":[438,1,0,2],"./fr":[439,1,0,2],"./fr.js":[439,1,0,2],"./he":[440,1,0,2],"./he.js":[440,1,0,2],"./hr":[441,1,0,2],"./hr.js":[441,1,0,2],"./hu":[442,1,0,2],"./hu.js":[442,1,0,2],"./hy-AM":[443,1,0,2],"./hy-AM.js":[443,1,0,2],"./id":[444,1,0,2],"./id.js":[444,1,0,2],"./it":[445,1,0,2],"./it.js":[445,1,0,2],"./ja":[446,1,0,2],"./ja.js":[446,1,0,2],"./kg":[447,1,0,2],"./kg.js":[447,1,0,2],"./km":[448,1,0,2],"./km.js":[448,1,0,2],"./ko":[449,1,0,2],"./ko.js":[449,1,0,2],"./ku":[450,1,0,2],"./ku.js":[450,1,0,2],"./kz":[451,1,0,2],"./kz.js":[451,1,0,2],"./lt":[452,1,0,2],"./lt.js":[452,1,0,2],"./lv":[453,1,0,2],"./lv.js":[453,1,0,2],"./mn":[454,1,0,2],"./mn.js":[454,1,0,2],"./nb-NO":[455,1,0,2],"./nb-NO.js":[455,1,0,2],"./nl":[456,1,0,2],"./nl.js":[456,1,0,2],"./pl":[457,1,0,2],"./pl.js":[457,1,0,2],"./pt":[459,1,0,2],"./pt-br":[458,1,0,2],"./pt-br.js":[458,1,0,2],"./pt.js":[459,1,0,2],"./ro":[460,1,0,2],"./ro.js":[460,1,0,2],"./ru-RU":[461,1,0,2],"./ru-RU.js":[461,1,0,2],"./sk":[462,1,0,2],"./sk.js":[462,1,0,2],"./sl":[463,1,0,2],"./sl.js":[463,1,0,2],"./sr":[464,1,0,2],"./sr.js":[464,1,0,2],"./sv-SE":[465,1,0,2],"./sv-SE.js":[465,1,0,2],"./ta":[466,1,0,2],"./ta.js":[466,1,0,2],"./th":[467,1,0,2],"./th.js":[467,1,0,2],"./tk":[468,1,0,2],"./tk.js":[468,1,0,2],"./tr-TR":[469,1,0,2],"./tr-TR.js":[469,1,0,2],"./ua":[470,1,0,2],"./ua.js":[470,1,0,2],"./ug-CN":[471,1,0,2],"./ug-CN.js":[471,1,0,2],"./uz-UZ":[472,1,0,2],"./uz-UZ.js":[472,1,0,2],"./vi":[473,1,0,2],"./vi.js":[473,1,0,2],"./zh-CN":[217],"./zh-CN.js":[217],"./zh-TW":[474,1,0,2],"./zh-TW.js":[474,1,0,2]};function o(t){if(!n.o(r,t))return Promise.resolve().then((function(){var e=new Error("Cannot find module '"+t+"'");throw e.code="MODULE_NOT_FOUND",e}));var e=r[t],o=e[0];return Promise.all(e.slice(1).map(n.e)).then((function(){return n.t(o,7)}))}o.keys=function(){return Object.keys(r)},o.id=683,t.exports=o}}]);