    ...
    [7], {
        ...
        10:
            ...
            function(t, e, n) {
                ...
                (function(t) { /* unused harmony export Store */
                    ...
                    p.state.get = function() {
                        ...
                        void 0 === n && (n = {}), "string" == typeof t && (t = [t]), this._modules.register(t, e), m(this, this.state, t, this._modules.get(t), n.preserveState),
                    ...
                    var T = {
                        ...
                        createLogger: function(t) {
                            ...
                            return void 0 === l && (l = console),
                                function(t) {
                                    var f = o(t.state);
                                    void 0 !== l && (s && t.subscribe((function(t, a) {
                                        var c = o(a);
                                        if (n(t, f, c)) {
                                            var s = P(),
                                                u = i(t),
                                                d = "mutation " + t.type + s;
                                            k(l, d, e), l.log("%c prev state", "color: #9E9E9E; font-weight: bold", r(f)), l.log("%c mutation", "color: #03A9F4; font-weight: bold", u), l.log("%c next state", "color: #4CAF50; font-weight: bold", r(c)), $(l)
                                        }
                                        f = c
                                        ...
                                        if (a(t, n)) {
                                            var r = P(),
                                                o = c(t),
                                                i = "action " + t.type + r;
                                            k(l, i, e), l.log("%c action", "color: #03A9F4; font-weight: bold", o), $(l)
                                        }
                                    })))
                                }
                        }
        ...
        233:
            ...
            function(t, e, n) {
                ...
                e.a = function(t) {
                    ...
                    }), a && (i.level = 0), a && e.query.debug && (i.level = 5), i.wrapConsole()
                }
            },
        /***/
        234:
            ...
            function(t, e, n) {
                ...
                e.a = function(t) {
                    ...
                    var e = t.store,
                        n = t.req,
                        o = t.$config,
                        i = Object(r.a)(n, o.WEB_RESOURCE_CDN_URL);
                    i.endsWith("/static") || (i += "/static"), e.commit("SET_WEB_RESOURCE_CDN_URL", i)
                }
            },
        /***/
        237:
        ...
        238:
            ...
            function(t, e, n) {
                ...
                var r = n(4),
                    o = n(5),
                    i = (n(28), n(14), n(18), n(20), n(16), n(21), n(8), n(9), n(6), n(11), n(12), n(81)),
                    a = n(62);
                /* harmony import */
                function c(t, e) {
                    var n = Object.keys(t);
                ...
                /* harmony default export */
                e.a = function() {
                    var t = Object(o.a)(regeneratorRuntime.mark((function t(e, r) {
                        var c, u, l, f, d, p, v, h, g, m, y, _;
                        return regeneratorRuntime.wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return c = e.$axios, u = e.store, l = e.route, f = e.app, d = e.$config, e.redirect, p = {}, // 動態導入所需模組
                                        t.next = 4, Promise.resolve().then(n.t.bind(null, 223, 7));
                                case 4:
                                    return v = t.sent, h = v.default, t.next = 8, Promise.all( /* import() */ [n.e(1), n.e(0), n.e(2)]).then(n.bind(null, 256));
                                case 8:
                                    g = t.sent, m = g.isArray, y = g.isObject, // 需要連線自簽憑證時才需要，目前都直接連測試機，固不需要
                                                    ...
                                                    for (;;) switch (t.prev = t.next) {
                                                        ...
                                                        case 6:
                                                            i = {
                                                                redirect: l.fullPath,
                                                                m: e.data.Code
                                                            }, null !== (r = e.headers) && void 0 !== r && r["x-trace"] && (i.trace = e.headers["x-trace"]), null !== (o = l.name) && void 0 !== o && o.includes("error") ? console.log("已經在錯誤頁，不轉導") : window.onNuxtReady((function() {
                                                                window.$nuxt.$router.push({
                                                                    path: f.localePath("/error"),
                                                                    query: i
                                                                })
                                                            }));
                                                        case 9:
                                            ...
                                            if (d.LOG_API_URL) {
                                                ...
                                                if (m(t)) {
                                                    var r = t.map((function(t) {
                                                        ...
                                                        return Object(i.a)(s(s({}, t), {}, {
                                                            Trace: r
                                                        }), n)
                                                    }));
                                                    // beforeunload 要用的話，需使用 fetch api
                                                    return fetch("".concat(d.LOG_API_URL, "/log/js-web-list"), {
                                                        method: "POST",
                                                        ...
                                                        keepalive: !0
                                                    }).catch((function() {})), void u.commit("errorHandle/emptyLogs")
                                                }
                                                if (y(t)) {
                                                    ...
                                                    fetch("".concat(d.LOG_API_URL, "/log/js-web"), {
                                                        ...
                                                        keepalive: !0
                                                    }).catch((function() {})), u.commit("errorHandle/emptyLogs")
                                                }
                                            }
                                        },
                                        /**
                                        ...
                                        p.getGameInfoList = function() {
                                            return _.get("/game-setting/game-info-list", {
                                                isGlobal: !0
                                            })
                                        },
                                        /**
                                        ...
                                        p.getGameEntrance = function(t, e, n, r) {
                                            return Object(a.a)(d.WEB_ID, "getGameEntrance") ? _.get("/game-entrance/".concat(t, "/").concat(e, "/").concat(n, "/").concat(r)) : Promise.resolve([])
                                        },
                                        /**
                                         * 取得跑馬燈列表
                                         * @param {string} apiId
                                        ...
                                        p.getBanner = function(t, e, n, r) {
                                            return Object(a.a)(d.WEB_ID, "getBanner") ? n && r ? _.get("/banner/".concat(t, "/").concat(e, "/").concat(n, "/").concat(r)) : n ? _.get("/banner/".concat(t, "/").concat(e, "/lang/").concat(n)) : _.get("/banner/".concat(t, "/").concat(e)) : Promise.resolve([])
                                        },
                                        /**
                                         * 取得動態賠率
                                         * @param {string} apiId
                                        ...
                                        p.getRtpInfo = function(t, e, n) {
                                            return Object(a.a)(d.WEB_ID, "getRtpInfo") ? null != n ? _.get("/game-setting/rtp/".concat(t, "/").concat(e, "/").concat(n)) : _.get("/game-setting/rtp/".concat(t, "/").concat(e)) : Promise.resolve(null)
                                        },
                                        /**
                                         * 取得幣別顯示
                                        ...
                                        p.getToken = function(t) {
                                            return "{token}" === t ? Promise.resolve(null) : _.post("/token", {
                                                Token: t
                                            }, {
                                                isGlobal: !0
                                            })
                                        ...
                                        p.getActionPageRankingSetting = function(t, e, n, r, o, i, a) {
                                            ...
                                            return null != a && (c.Sac = a), _.get("/rank/ranking-setting", {
                                                params: c
                                            })
                                        },
                                        /**
                                        ...
                                        p.getSwitchOffInfo = function(t) {
                                            return Object(a.a)(d.WEB_ID, "getSwitchOffInfo") ? _.get("/game-setting/switch-off-status/".concat(t)) : Promise.resolve({})
                                        },
                                        /**
                                         * 取得活動推廣頁列表
                                         * @param {number} apiId apiId
                                        ...
                                        p.getTadaApiIdList = function() {
                                            ...
                                            return _.get("/event/".concat(t, "/").concat(e)).then((function(t) {
                                                return t.PrizeList = t.PrizeList.map((function(t) {
                                                    if (t.imgSrc = "/images/event/prizes/prize_".concat(t.PrizeNo, ".png"), t.displayDescI18n = "i18_EVENT_PRIZE_".concat("TADA" === d.WEB_ID && t.PrizeNo >= 1 && t.PrizeNo <= 5 ? "TADA_NAME" : "NAME", "_").concat(t.PrizeNo), t.displayAmount = "X ".concat(t.PrizeAmount), t.PrizeNo > 300 && t.PrizeNo < 400) {
                                                        t.imgSrc = "/images/event/prizes/prize_300.png",
                                                            // PrizeNo 319 為印尼幣，採用印尼幣系統格式顯示
                                                            t.displayAmount = 319 === t.PrizeNo ? f.$utils.formatNumberIDR(t.PrizeAmount, 3, {
                                                                rb: !1
                                                            }) : f.$utils.formatNumberKMBT(t.PrizeAmount, 3, {
                                                                k: !1
                                        ...
                                        p.sendGiftcodeEmail = function(t) {
                                            var e = t.eventId,
                                                ...
                                                r = t.email,
                                                o = t.configSet;
                                            return _.post("/giftcode/send-email/".concat(e), {
                                                Email: r,
                                                TemplateId: n,
                                                AwsConfigSetName: o
                                            })
        ...
        239:
            ...
            function(t, e, n) {
                ...
                /* harmony import */
                var r = n(5),
                    o = (n(28), n(14), n(18), n(20), n(16), n(21), n(36), n(223)),
                    i = n.n(o),
                    a = n(40),
                    c = n.n(a),
                    s = n(62);
                ...
                e.a = function(t, e) {
                    ...
                    f.onRequest((function(t) {
                                    ...
                                    for (;;) switch (t.prev = t.next) {
                                        case 0:
                                            ...
                                            if (console.log("API ResponseError:", e.data), r = !0, // 記錄錯誤網址
                                                ...
                                                a.$message({
                                                    ...
                                                    type: "error"
                                                }), !e.config.isGlobal || 9101 !== e.data.Code &&
                                                // HTTP 401
                                                9100 !== e.data.Code) {
                                                t.next = 12;
                                                break
                                        ...
                                        case 9:
                                            s = {
                                                redirect: u.fullPath,
                                                m: e.data.Code
                                            }, null !== (i = e.headers) && void 0 !== i && i["x-trace"] && (s.trace = e.headers["x-trace"]), null !== (c = u.name) && void 0 !== c && c.includes("error") ? console.log("已經在錯誤頁，不轉導") : window.onNuxtReady((function() {
                                                window.$nuxt.$router.push({
                                                    path: a.localePath("/error"),
                                                    query: s
                                                })
                                            }));
                                        case 12:
                        ...
                        d.getVIPSetting = function() {
                            return Object(s.a)(l.WEB_ID, "getVIPSetting") ? f.get("/member/vip-setting") : Promise.reject({
                                Code: -1,
                                Message: "".concat(l.WEB_ID, "環境沒有vip設定")
                            })
                        },
                        /**
                         * 取得VIP簽到設定
                         ...
                         */
                        d.getVIPSignSetting = function(t) {
                            return f.get("/member/vip-sign-setting/".concat(t))
                        },
                        /**
                         * 取得VIP等級
                        ...
                        d.isNicknameEnable = function() {
                            return Object(s.a)(l.WEB_ID, "isNicknameEnable") ? f.get("/game-setting/is-enable/NickNameEnable") : Promise.resolve({
                                IsEnable: !1
                            })
                        },
                        /**
                        ...
                        d.getHistoryRecord = function(t) {
                            var e = t.gameId,
                                ...
                                O = {
                                    ...
                                    StartRowIndex: l,
                                    EndRowIndex: d,
                                    LogIndexAsRoundIndex: h,
                                    EnterTime: p
                                };
                            return s && (O.RoundIndex = s), u && (O.LogIndex = u), o && (O.Date = o, O.TimeZoneOffsetMinutes = c()().utcOffset()), i && (O.Minutes = i),
                                // if (gameId === 'coin01' && store.state.detailCreateTime) {
                                //   sendData.CreateTime = store.state.detailCreateTime
                                // }
                                null != m && (O.OffsetStartTime = m), null != _ && (O.OffsetStartRowIndex = _), null != w && (O.OffsetDbIndex = w), f.get("/history/".concat(e, "/get-history-record"), {
                                    params: O
                                }).then((function(t) {
                                    return null == t ? [] : t.map((function(t) {
                                        ...
                                        return e.prizeTypeImage = a.$utils.getPrizeTypeImagePath(e.Type, n, r),
                                            ...
                                            // 魚機新增道具卡
                                            e.typeImage = a.$utils.getFreeSpinImagePath(e.Type, n, r), e
                                    }))
                                })).catch((function(t) {
                        ...
                        d.getGoHistoryRecord = function(t) {
                            ...
                            return s && (O.RoundIndex = s), u && (O.LogIndex = u), o && (O.Date = o, O.TimeZoneOffsetMinutes = c()().utcOffset()), i && (O.Minutes = i),
                                ...
                                //   sendData.CreateTime = store.state.detailCreateTime
                                // }
                                null != m && (O.OffsetStartTime = m), null != _ && (O.OffsetStartRowIndex = _), null != w && (O.OffsetDbIndex = w), f.get("/v2/history/".concat(e, "/get-history-record"), {
                                    params: O
                                }).then((function(t) {
                                    return null == t ? [] : t.map((function(t) {
                                        var e = a.$utils.merge({}, t);
                        ...
                        d.getDetailRecord = function(t, e, n, r, o, i, a) {
                            ...
                            return a && (c.LogIndex = a), f.get("/history/".concat(t, "/get-detail-record"), {
                                params: c
                            }).then((function(t) {
                                return null == t ? [] : t
                            })).catch((function(t) {
                        ...
                        d.getGoDetailRecord = function(t, e, n, r, o, i, a) {
                            ...
                            return a && (c.LogIndex = a), f.get("/v2/history/".concat(t, "/get-detail-record"), {
                                params: c
                            }).then((function(t) {
                                return null == t ? [] : t
                            })).catch((function(t) {
                        ...
                        d.getDetailInfo = function(t, e, n) {
                            return f.get("/history/".concat(t, "/get-detail-info/").concat(e).concat(n ? "/" + n : "")).catch((function(t) {
                                return t
                            }))
                        },
                        /**
                        ...
                        d.getGoDetailInfo = function(t, e, n) {
                            return f.get("/v2/history/".concat(t, "/get-detail-info/").concat(e).concat(n ? "/" + n : "")).catch((function(t) {
                                return t
                            }))
                        },
                        /**
                         ...
                         * @returns {Promise<object>} 是否成功
                         */
                        d.getGoSyDetailInfo = function(t, e) {
                            return f.get("/v2/history/".concat(t, "/get-detail-info/").concat(e)).catch((function(t) {
                                return t
                            }))
                        },
                        /**
                         ...
                         * @returns {Promise<object>} 是否成功
                         */
                        d.getGoBombDetailRecord = function(t, e, n) {
                            return f.get("/v2/history/".concat(t, "/get-bomb-detail-record/").concat(e, "/").concat(n)).catch((function(t) {
                                return t
                            }))
                        },
                        /**
                        ...
                        d.getPlateInfo = function(t, e, n) {
                            return f.get("/history/".concat(t, "/get-log-plate-info/").concat(e, "/").concat(n)).then((function(t) {
                                return Array.isArray(t) && t.length > 0 ? t.map((function(t) {
                                    var e = a.$utils.merge({}, t),
                                        n = e.SymbolLength ? e.SymbolLength.split("") : [],
                                        r = e.PlateNumStr ? e.PlateNumStr.split(",") : [],
                                        o = e.PlateMult ? e.PlateMult.split(",") : [];
                                    // 整理盤面資訊
                                    return e.plateGrid = e.Plate.split("").map((function(t, e) {
                                        var i = {
                                                symbol: t,
                                                selected: null
                                            },
                                            ...
                                            c = r[e],
                                            s = o[e];
                                        return a && (i.symbolLength = a),
                                            // lbingo 金幣數字
                                            c && (i.plateNum = c),
                                            // 每格倍率
                                            s && (i.plateMult = "0" === s ? null : s), i
                                    })), e
                                })) : []
                            })).catch((function(t) {
                                return t
                        ...
                        d.getGoPlateInfo = function(t, e, n) {
                            return f.get("/v2/history/".concat(t, "/get-log-plate-info/").concat(e, "/").concat(n)).then((function(t) {
                                return Array.isArray(t) && t.length > 0 ? t.map((function(t) {
                                    var e = a.$utils.merge({}, t),
                                        n = e.SymbolLength ? e.SymbolLength.split("") : [],
                                        r = e.PlateNumStr ? e.PlateNumStr.split(",") : [],
                        ...
                        d.getCSV2PlateInfo = function(t, e, n) {
                            ...
                            return f.get("/history/".concat(t, "/get-log-plate-info/").concat(e, "/").concat(n, "/").concat(r)).then((function(t) {
                                return Array.isArray(t) && t.length > 0 ? t.map((function(t) {
                                    var e = a.$utils.merge({}, t),
                                        n = e.Plate;
                                    return n.forEach((function(t) {
                                        ...
                                        t.plateGrid = t.Plate.split("").map((function(t, i) {
                                            var a = {
                                                ...
                                                u = r[i],
                                                l = o[i];
                                            return c && (a.symbolLength = c),
                                                // lbingo 金幣數字
                                                s && (a.plateNum = s),
                                                // 每格倍率
                                                u && (a.plateMult = "0" === u ? null : u),
                                                // 盤面乘倍框倍率
                                                l && (a.frameMult = "1" === l || "0" === l ? null : l), a
                                        }))
                                    })), e.plate = n, e
                                })) : []
                            })).catch((function(t) {
                        ...
                        d.getGoCSV2PlateInfo = function(t, e, n) {
                            var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "";
                            return f.get("/v2/history/".concat(t, "/get-log-plate-info/").concat(e, "/").concat(n, "/").concat(r)).then((function(t) {
                                return Array.isArray(t) && t.length > 0 ? t.map((function(t) {
                                    var e = a.$utils.merge({}, t),
                                        n = e.Plate;
                                    return n.forEach((function(t) {
                         ...
                         * @returns {Promise<object>} 是否成功
                         */
                        d.getGoRouletteInfo = function(t) {
                            var e = t.lang,
                                n = t.gameId,
                                r = t.roundIndex,
                                o = t.historyId;
                            return f.get("/v2/history/".concat(n, "/get-detail-info/").concat(e, "/").concat(r, "/").concat(o)).catch((function(t) {
                                return t
                            }))
                        },
                        /**
                         ...
                         * @returns {Promise<object>} 是否成功
                         */
                        d.getGoTpPlateInfo = function(t, e) {
                            return f.get("/v2/history/".concat(t, "/get-plate-info/").concat(e)).catch((function(t) {
                                return t
                            }))
                        },
                        /**
                         ...
                         * @returns {Promise<object>} 是否成功
                         */
                        d.getGoTpStepDetailRecords = function(t, e) {
                            return f.get("/v2/history/".concat(t, "/get-step-detail-record/").concat(e)).catch((function(t) {
                                return t
                            }))
                        },
                        /**
                         ...
                         * @returns {Promise<object>} 是否成功
                         */
                        d.getGoMinigame1Info = function(t) {
                            var e = t.gameId,
                                n = t.roundIndex;
                            return f.get("/v2/history/".concat(e, "/get-log-plate-info/").concat(n)).catch((function(t) {
                                return t
                            }))
                        },
                        /**
                        ...
                        d.getBingoInfo = function(t) {
                            var e = t.lang,
                                n = t.gameId,
                                r = t.roundIndex;
                            return f.get("/history/".concat(n, "/get-detail-info/").concat(e, "/").concat(r)).then((function(t) {
                                var e, n, r = a.$utils.merge({}, t);
                                // 將 Cards 內容重組成跟 summaryList 一樣
                                return r.Cards = (null == r || null === (e = r.Cards) || void 0 === e ? void 0 : e.map((function(t) {
                                    var e, n, r = [],
                                        o = (null === (e = t.Balls) || void 0 === e ? void 0 : e.map((function(t) {
                                            return {
                                                selected: null,
                                                Number: t.Number,
                                                Color: t.Color,
                                        ...
                                        i = (null === (n = t.Awards) || void 0 === n ? void 0 : n.map((function(t) {
                                            return {
                                                S: t.Number,
                                                Award: t.Line,
                                                L: t.Odds,
                                ...
                                }))) || [], null === (n = r.Bonus) || void 0 === n || n.forEach((function(t, e) {
                                    var n;
                                    t.Cards = (null === (n = t.Cards) || void 0 === n ? void 0 : n.map((function(t) {
                                        var n, r, o = [],
                                            i = (null === (n = t.Balls) || void 0 === n ? void 0 : n.map((function(t) {
                                                return {
                                                    selected: null,
                                                    Number: t.Number,
                                                    Color: t.Color,
                                            ...
                                            a = (null === (r = t.Awards) || void 0 === r ? void 0 : r.map((function(t) {
                                                return {
                                                    S: t.Number,
                                                    Award: t.Line,
                                                    L: t.Odds,
                         ...
                         * @returns {Promise<object>} 是否成功
                         */
                        d.getGoBingoInfo = function(t) {
                            var e = t.lang,
                                n = t.gameId,
                                r = t.roundIndex;
                            return f.get("/v2/history/".concat(n, "/get-detail-info/").concat(e, "/").concat(r)).then((function(t) {
                                var e, n, r = a.$utils.merge({}, t);
                                // 將 Cards 內容重組成跟 summaryList 一樣
                                return r.Cards = (null == r || null === (e = r.Cards) || void 0 === e ? void 0 : e.map((function(t) {
                                    var e, n, r = [],
                         ...
                         * @returns {Promise<object>} 是否成功
                         */
                        d.getGoDtmDetailInfo = function(t) {
                            var e = t.gameId,
                                n = t.roundIndex;
                            return f.get("/v2/history/".concat(e, "/get-detail-info/").concat(n)).catch((function(t) {
                                return t
                            }))
                        },
                        /**
                         ...
                         * @returns {Promise<object>} 是否成功
                         */
                        d.getGoSicbomDetailInfo = function(t) {
                            var e = t.lang,
                                n = t.gameId,
                                r = t.roundIndex;
                            return f.get("/v2/history/".concat(n, "/get-detail-info/").concat(e, "/").concat(r)).catch((function(t) {
                         ...
                         * @returns {Promise<object>} 是否成功
                         */
                        d.getGoSicbomBoxDetailInfo = function(t) {
                            var e = t.lang,
                                n = t.gameId,
                                r = t.roundIndex;
                            return f.get("/v2/history/".concat(n, "/get-box-detail-info/").concat(e, "/").concat(r)).catch((function(t) {
                                return t
                            }))
                        },
                        /**
            ...
            function(t, e, n) {
                ...
                e.a = function(t) {
                    ...
                    r.default.config.errorHandler = function(t, r, o) {
                            var i, a, c, s;
                            console.log("Logged in Vue global error handler: ", t.name), console.log("component name: ", null !== (i = null == r || null === (a = r.$options) || void 0 === a ? void 0 : a.name) && void 0 !== i ? i : null), console.log("info: ", o), e.commit("errorHandle/addLog", {
                        ...
                        window.addEventListener("error", (function(t, r, o, i, a) {
                            ...
                            null != t && null !== (c = t.includes) && void 0 !== c && c.call(t, "chrome-extension") || (console.log("JS 錯誤:", t, r, o, i, a), e.commit("errorHandle/addLog", {
                                Url: location.origin + n.fullPath,
                        ...
                        window.addEventListener("unhandledrejection", (function(t) {
                            console.log("有未處理的 Promise Rejection (UNHANDLED PROMISE REJECTION)", t), e.commit("errorHandle/addLog", {
                                Url: location.origin + n.fullPath,
        ...
        241:
            ...
            function(t, e, n) {
                ...
                r.default.use(Object(o.a)()), r.default.use(i.a, {
        ...
        244:
            ...
            function(t, e, n) {
                ...
                var r = n(5),
                    o = n(15),
                    i = (n(28), n(21), n(6), n(20), n(16), n(93), n(22), n(25), n(14), n(24), n(288)),
                    a = n.n(i),
                    c = n(418),
                    s = n(40),
                    u = n.n(s),
                ...
                e.a = function(t) {
                    var e = t.app,
                        ...
                        p = function(t, n) {
                            var r = u()().format("YYYYMMDDHHmm"),
                                a = (null == n ? void 0 : n.map((function(t) {
                            ...
                            return i.$get(s, {
                                ...
                                var i = (null == n ? void 0 : n.filter((function(t) {
                                    return t.toLowerCase().includes("_style")
                                }))) || [];
                                i.length > 0 && i.forEach((function(e) {
                                    for (var n = Object(c.a)(r.Data[t], (function(t, n) {
                                            return n.includes(e)
                                        })), i = 0, a = Object.entries(n); i < a.length; i++) {
                    ...
                    e.i18n.onBeforeLanguageSwitch = function() {
                        var t = Object(r.a)(regeneratorRuntime.mark((function t(e, n) {
                            return regeneratorRuntime.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return t.next = 2, Promise.all([p(n), h(n)]);
                                    case 2:
                                    case "end":
                                        return t.stop()
                                }
                    ...
                    }(), e.i18n.getRemoteLangMessage = p, e.i18n.changeEelmentUiLocale = h
                }
            },
        /***/
        245:
                    ...
                    var t = {
                        install: function() {
                            window.Clipboard = function(t, e, n) {
                                ...
                                function o() {
                                    var o, i;
                                    n.userAgent.match(/ipad|iphone/i) ? ((o = e.createRange()).selectNodeContents(r), (i = t.getSelection()).removeAllRanges(), i.addRange(o), r.setSelectionRange(0, 999999)) : r.select()
                                }
                                return {
                                    copy: function(t) {
                                        ! function(t) {
                                            (r = e.createElement("textArea")).value = t, e.body.appendChild(r)
                                        }(t), o(), e.execCommand("Copy"), e.body.removeChild(r)
                                    }
                                }
            ...
            function(t, e, n) {
                ...
                e.a = function(t, e) {
                    var n = t.app,
                        ...
                        o = t.route,
                        i = function() {
                            n.$utils.cssVar("mag", n.$utils.cssVar("mag_web")), n.$utils.cssVar("font-size-current", n.$utils.cssVar("font-size-web")), n.$utils.cssVar("font-size-current-md", n.$utils.cssVar("font-size-web-md")), n.$utils.cssVar("font-size-current-xl", n.$utils.cssVar("font-size-web-xl"))
                        },
                        a = function() {
                            n.$utils.cssVar("mag", n.$utils.cssVar("mag_app")), n.$utils.cssVar("font-size-current", n.$utils.cssVar("font-size-app")), n.$utils.cssVar("font-size-current-md", n.$utils.cssVar("font-size-app-md")), n.$utils.cssVar("font-size-current-xl", n.$utils.cssVar("font-size-app-xl"))
                        },
                        c = function() {
                            n.$utils.cssVar("mag", n.$utils.cssVar("mag_webapp")), n.$utils.cssVar("font-size-current", n.$utils.cssVar("font-size-webapp")), n.$utils.cssVar("font-size-current-md", n.$utils.cssVar("font-size-webapp-md")), n.$utils.cssVar("font-size-current-xl", n.$utils.cssVar("font-size-webapp-xl"))
                        },
                        s = function() {
                            n.$utils.cssVar("mag", n.$utils.cssVar("mag_lobby")), n.$utils.cssVar("font-size-current", n.$utils.cssVar("font-size-lobby")), n.$utils.cssVar("font-size-current-md", n.$utils.cssVar("font-size-lobby-md")), n.$utils.cssVar("font-size-current-xl", n.$utils.cssVar("font-size-lobby-xl"))
                        };
                    // 給遊戲大廳使用
                    e("zoomStyle", {
                        ...
                        initOtherLayout: function() {
                            // 設定預設字體大小
                            n.$utils.cssVar("--font-size-current", "16px"), n.$utils.cssVar("--font-size-current-md", "16px"), n.$utils.cssVar("--font-size-current-xl", "16px")
                        },
                        addLobbyStyle: s,
                        addWebStyle: i,
                        addWebAppStyle: c,
        ...
        249:
            ...
            function(t, e, n) {
                ...
                /* harmony import */
                var r = n(5),
                    o = (n(28), n(22), n(94), n(18), n(20), n(16), n(25), n(14), n(24), n(41), n(55));
                /* harmony import */
                function i() {
                    return (i = Object(r.a)(regeneratorRuntime.mark((function t(e) {
                        var n, r, i, a, c, s, u, l, f, d, p;
                        return regeneratorRuntime.wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0: // 如果是 404 頁面就不執行呼叫 api 的動作
                                    if (n = e.app, r = e.store, i = e.route, a = e.query, e.isDev, e.redirect, c = e.$config, !n.router.resolve(i.path.replace("/index.html", "")).route.name.startsWith("all")) {
                                        t.next = 4;
                                        break
                                    }
                                ...
                                case 4:
                                    ...
                                    if (
                                        ...
                                        // 印度目前以domain來區分
                                        "IN" === r.state.webId && location.hostname.includes("jilistar") && (l = Object(o.a)(202)) && r.commit("setVal", l), !a.token || i.path.includes("repair")) {
                                        t.next = 19;
                                        break
                                    }
                                    return r.commit("cookies/SET_GAME_TOKEN", a.token), t.next = 17, Promise.all([
                                        ...
                                        r.dispatch("getCurrencyDisplayList"), r.dispatch("GetSymbolStyleList")
                                    ]).catch((function(t) {
                                ...
                                case 17:
                                    ...
                                    break;
                                case 19:
                                    return t.next = 21, Promise.all([n.i18n.getRemoteLangMessage(n.i18n.locale), n.i18n.changeEelmentUiLocale(n.i18n.locale), r.dispatch("getGameSetting"),
                                        // store.dispatch('getGameGroup'),
                                        // store.dispatch('getUserApiInfo'),
                                        r.dispatch("getCurrencyDisplayList"), r.dispatch("GetSymbolStyleList")
                                    ]).catch((function(t) {
                                ...
                                case 21:
                                    ...
                                    a.posthost ? r.commit("control/setPostMessageHost", a.posthost) : r.commit("control/setPostMessageHost", ""),
                                        ...
                                        // TaDaSSS 專用設定
                                        "TADA" === r.state.webId && a.game && (d = null === (f = r.state.gameSettings) || void 0 === f ? void 0 : f.find((function(t) {
                                            return t.No === +a.game
                                        })), p = Object(o.a)(20002), d && d.Id.toLocaleLowerCase().startsWith("sss-") && p && r.commit("setVal", p));
                                case 25:
                                case "end":
                                    return t.stop()
                            }
            ...
            function(t, e, n) {
                ...
                e.a = function(t) {
                    ...
                    var e = t.store,
                        ...
                        o = t.redirect,
                        i = t.$utils;
                    window.onNuxtReady(Object(r.a)(regeneratorRuntime.mark((function t() {
                            var r, o, i;
                            return regeneratorRuntime.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return window.$nuxt.$loading.finish(),
                                            // 記錄載入結束時間
                                            ...
                                            }), r = n.query.apiid || 0, o = r || e.getters.apiId, t.next = 8, e.dispatch("getSwitchOffInfo", o);
                                    case 8:
                                        // 禁止使用者縮放處理
                                        document.addEventListener("touchstart", (function(t) {
                                            ...
                                            passive: !1
                                        }), i = 0, document.addEventListener("touchend", (function(t) {
        ...
        3:
            ...
            function(t, e, n) {
                ...
                n.r(e),
                    /* WEBPACK VAR INJECTION */
                    function(t, r) { /* harmony export (binding) */
                        ...
                        var st = function() {
                                return void 0 === rt && (
                                    /* istanbul ignore if */
                                    rt = !Z && void 0 !== t && (t.process && "server" === t.process.env.VUE_ENV)), rt
                            },
                        ...
                        var ft, dt = "undefined" != typeof Symbol && lt(Symbol) && "undefined" != typeof Reflect && lt(Reflect.ownKeys); // $flow-disable-line
                        /* istanbul ignore if */
                        // use native Set when available.
                        ft = "undefined" != typeof Set && lt(Set) ? Set : /** @class */ function() {
                            function t() {
                        ...
                        ***************************************************************************** */
                        ...
                        var Lt = {
                            ...
                            At = /** @class */ function() {
                                function t(t, e, n) {
                                    if (void 0 === e && (e = !1), void 0 === n && (n = !1), this.value = t, this.shallow = e, this.mock = n,
                                        // this.value = value
                                        this.dep = n ? Lt : new Ct, this.vmCount = 0, q(t, "__ob__", this), i(t)) {
                                        if (!n)
                                            if (Y) t.__proto__ = kt;
                         ...
                         */
                        function Nt(t, e, n) {
                            return t && S(t, "__ob__") && t.__ob__ instanceof At ? t.__ob__ : !Et || !n && st() || !i(t) && !p(t) || !Object.isExtensible(t) || t.__v_skip /* ReactiveFlags.SKIP */ || Yt(t) || t instanceof gt ? void 0 : new At(t, e, n)
                        }
                        /**
                                ...
                                return Object.defineProperty(t, e, {
                                    ...
                                    set: function(e) {
                                        ...
                                        if (F(r, e)) {
                                            ...
                                            d = o ? e && e.__ob__ : Nt(e, !1, a), s.notify()
                                        }
                                    }
                                }), s
                            }
                        ...
                        function Dt(t, e, n) {
                            if (!Wt(t)) {
                                var r = t.__ob__;
                                return i(t) && h(e) ? (t.length = Math.max(t.length, e), t.splice(e, 1, n),
                                    // when mocking for SSR, array methods are not hijacked
                                    r && !r.shallow && r.mock && Nt(n, !1, !0), n) : e in t && !(e in Object.prototype) ? (t[e] = n, n) : t._isVue || r && r.vmCount ? n : r ? (Rt(r.value, e, n, void 0, r.shallow, r.mock), r.dep.notify(), n) : (t[e] = n, n)
                            }
                        }
                         ...
                         */
                        function Ft(t) {
                            return Gt(t, !0), q(t, "__v_isShallow" /* ReactiveFlags.IS_SHALLOW */ , !0), t
                        }

                        function Gt(t, e) {
                            // if trying to observe a readonly proxy, return the readonly version.
                            if (!Wt(t)) {
                                Nt(t, e, st() /* ssr mock reactivity */ );
                                0
                            }
                        }
                        ...
                        function le(t, e) {
                            ...
                            q(t, n, o), q(o, "__v_isReadonly" /* ReactiveFlags.IS_READONLY */ , !0), q(o, "__v_raw" /* ReactiveFlags.RAW */ , t), Yt(t) && q(o, Kt, !0), (e || Vt(t)) && q(o, "__v_isShallow" /* ReactiveFlags.IS_SHALLOW */ , !0);
                        ...
                        function Se(t, e, n) {
                            ...
                            if (Yt(t) ? (f = function() {
                                    return t.value
                                }, h = Vt(t)) : Ut(t) ? (f = function() {
                                    return t.__ob__.dep.depend(), t
                                }, c = !0) : i(t) ? (g = !0, h = t.some((function(t) {
                                    return Ut(t) || Vt(t)
                                })), f = function() {
                                    return t.map((function(t) {
                                        return Yt(t) ? t.value : Ut(t) ? (t.__ob__.dep.depend(), ir(t)) : l(t) ? v(t, ge) : void 0
                                    }))
                                }) :
                                // getter with cb
                                f = l(t) ? e ? function() {
                            ...
                            if (st())
                                ...
                                return y = N, e ? a && v(e, he, [f(), g ? [] : void 0, y]) : f(), N;
                            var _ = new ur(pt, f, N, {
                                lazy: !0
                            });
                            _.noRecurse = !e;
                            ...
                            return _.run = function() {
                                ...
                                // initial run
                                e ? a ? _.run() : b = _.get() : "post" === u && p ? p.$once("hook:mounted", (function() {
                                    return _.get()
                                })) : _.get(),
                                function() {
                                    _.teardown()
                        ...
                        function Ae(t, e, n, r, o, i) {
                            var c, u, l, f;
                            for (c in t) u = t[c], l = e[c], f = Te(c), a(u) || (a(l) ? (a(u.fns) && (u = t[c] = Le(u, i)), s(f.once) && (u = t[c] = o(f.name, u, f.capture)), n(f.name, u, f.capture, f.passive, f.params)) : u !== l && (l.fns = u, t[c] = l));
                        ...
                        function ze(t, e) {
                            var n, r, o, l, f = [];
                            for (n = 0; n < t.length; n++) a(r = t[n]) || "boolean" == typeof r || (l = f[o = f.length - 1],
                                //  nested
                                i(r) ? r.length > 0 && (
                        ...
                        function Fe(t, e, n, r) {
                            ...
                            i ? (
                                // scoped slot
                                n = n || {}, r && (n = L(L({}, r), n)), o = i(n) || (l(e) ? e() : e)) : o = this.$slots[t] || (l(e) ? e() : e);
                            var a = n && n.slot;
                        ...
                        function Ve(t, e, n, r, o) {
                            ...
                            return o && r && !W.keyCodes[e] ? Ue(o, r) : i ? Ue(i, t) : r ? P(r) !== e : void 0 === t
                        }
                        /**
                                ...
                                if (f(n)) {
                                    ...
                                    var a = void 0,
                                        c = function(i) {
                                            ...
                                            var s = I(i),
                                                u = P(i);
                                            s in a || u in a || (a[i] = n[i], o && ((t.on || (t.on = {}))["update:".concat(i)] = function(t) {
                                                n[i] = t
                                            }))
                                        };
                                    for (var s in n) c(s)
                        ...
                        function tn(t) {
                            t._o = Je, t._n = _, t._s = m, t._l = Be, t._t = Fe, t._q = M, t._i = z, t._m = He, t._f = Ge, t._k = Ve, t._b = We, t._v = yt, t._e = mt, t._u = Ze, t._g = Ye, t._d = Xe, t._p = Qe
                        }
                        /**
                        ...
                        function en(t, e) {
                            ...
                            for (var n = {}, r = 0, o = t.length; r < o; r++) {
                                ...
                                if (
                                    ...
                                    a && a.attrs && a.attrs.slot && delete a.attrs.slot, i.context !== e && i.fnContext !== e || !a || null == a.slot)(n.default || (n.default = [])).push(i);
                                else {
                                    var c = a.slot,
                                        s = n[c] || (n[c] = []);
                        ...
                        function On(t, e, n, r, o, a) {
                            return (i(n) || u(n)) && (o = r, r = n, n = void 0), s(a) && (o = wn),
                                function(t, e, n, r, o) {
                                    if (c(n) && c(n.__ob__)) return mt();
                                    ...
                                    i(r) && l(r[0]) && ((n = n || {}).scopedSlots = {
                                        default: r[0]
                                    }, r.length = 0);
                                    o === wn ? r = De(r) : o === bn && (r = function(t) {
                                        for (var e = 0; e < t.length; e++)
                                    ...
                                    if ("string" == typeof e) {
                                        var u = void 0;
                                        s = t.$vnode && t.$vnode.ns || W.getTagNamespace(e), a = W.isReservedTag(e) ? new gt(W.parsePlatformTagName(e), n, r, void 0, void 0, t) : n && n.pre || !c(u = Kr(t.$options, "components", e)) ? new gt(e, n, r, void 0, void 0, t) : zr(u, n, t, r, e)
                                    } else
                                        // direct component options / constructor
                                        a = zr(e, n, t, r);
                                    return i(a) ? a : c(a) ? (c(s) && Cn(a, s), c(n) &&
                                        // ref #5318
                        ...
                        function Cn(t, e, n) {
                            if (t.ns = e, "foreignObject" === t.tag && (
                                    // use default namespace inside foreignObject
                                    e = void 0, n = !0), c(t.children))
                        ...
                        } else if (Q || "undefined" == typeof MutationObserver || !lt(MutationObserver) &&
                            // PhantomJS and iOS 7.x
                            "[object MutationObserverConstructor]" !== MutationObserver.toString())
                            // Fallback to setImmediate.
                            // Technically it leverages the (macro) task queue,
                            // but it is still a better choice than setTimeout.
                            $n = void 0 !== r && lt(r) ? function() {
                                r(Ln)
                            } : function() {
                                setTimeout(Ln, 0)
                            }
                        ...
                        ;
                            ...
                            var Nn = 1,
                                Rn = new MutationObserver(Ln),
                                Dn = document.createTextNode(String(Nn));
                            Rn.observe(Dn, {
                                characterData: !0
                            }), $n = function() {
                                Nn = (Nn + 1) % 2, Dn.data = String(Nn)
                            }, Pn = !0
                        }
                        ...
                        function Mn(t, e) {
                            ...
                            if (En.push((function() {
                                ...
                                })), Tn || (Tn = !0, $n()), !t && "undefined" != typeof Promise) return new Promise((function(t) {
                                n = t
                            }))
                        }
                        ...
                        function Fn(t) {
                            ...
                            var s = null,
                                ...
                                f = function() {
                                    var t;
                                    return s || (t = s = e().catch((function(t) {
                        ...
                        var Un = Gn("beforeMount"),
                            ...
                            Kn = Gn("activated"),
                            Yn = Gn("deactivated"),
                            Zn = Gn("serverPrefetch"),
                            Xn = Gn("renderTracked"),
                            Qn = Gn("renderTriggered"),
                            tr = Gn("errorCaptured");
                        ...
                        function ar(t, e) {
                            var n, r, o = i(t);
                            if (!(!o && !f(t) || t.__v_skip /* ReactiveFlags.SKIP */ || Object.isFrozen(t) || t instanceof gt)) {
                                if (t.__ob__) {
                                ...
                                if (o)
                                    for (n = t.length; n--;) ar(t[n], e);
                                else if (Yt(t)) ar(t.value, e);
                                else
                                    for (n = (r = Object.keys(t)).length; n--;) ar(t[r[n]], e)
                            }
                        }
                        var cr, sr = 0,
                            ur = /** @class */ function() {
                        ...
                        function mr(t, e) {
                            if (e) {
                                if (t._directInactive = !1, gr(t)) return
                        ...
                        function yr(t, e) {
                            if (!(e && (t._directInactive = !0, gr(t)) || t._inactive)) {
                                t._inactive = !0;
                        ...
                        function _r(t, e, n, r) {
                            ...
                            var a = t.$options[e],
                                c = "".concat(e, " hook");
                            if (a)
                                for (var s = 0, u = a.length; s < u; s++) jn(a[s], t, n || null, t, c);
                        ...
                        if (Z && !Q) {
                            ...
                            kr && "function" == typeof kr.now && Ir() > document.createEvent("Event").timeStamp && (
                        ...
                        function Pr() {
                            ...
                            var n = wr.slice(),
                                r = br.slice();
                            xr = br.length = wr.length = 0, Or = {}, Cr = Sr = !1,
                                // call component updated and activated hooks
                                function(t) {
                                    for (var e = 0; e < t.length; e++) t[e]._inactive = !0, mr(t[e], !0 /* true */ )
                                }
                            /**
                            ...
                            if (null == Or[e] && (t !== Ct.target || !t.noRecurse)) {
                                if (Or[e] = !0, Sr) {
                                    for (
                                        ...
                                        var n = br.length - 1; n > xr && br[n].id > t.id;) n--;
                                    br.splice(n + 1, 0, t)
                                }
                                // queue the flush
                                else br.push(t);
                        ...
                        function Tr(t, e) {
                            if (t) {
                                for (
                                    ...
                                    var n = Object.create(null), r = dt ? Reflect.ownKeys(t) : Object.keys(t), o = 0; o < r.length; o++) {
                                    var i = r[o];
                        ...
                        function Lr(t, e, n, r, a) {
                            var c, u = this,
                                l = a.options;
                            S(r, "_uid") ? (c = Object.create(r))._original = r : (
                            ...
                            var f = s(l._compiled),
                                d = !f;
                            this.data = t, this.props = e, this.children = n, this.parent = r, this.listeners = t.on || o, this.injections = Tr(l.inject, r), this.slots = function() {
                                ...
                                f && (
                                    ...
                                    this.$slots = this.slots(), this.$scopedSlots = on(r, t.scopedSlots, this.$slots)), l._scopeId ? this._c = function(t, e, n, o) {
                        ...
                        var Dr = {
                                ...
                                prepatch: function(t, e) {
                                    ...
                                    ! function(t, e, n, r, i) {
                                        ...
                                        var a = r.data.scopedSlots,
                                            c = t.$scopedSlots,
                                            s = !!(a && !a.$stable || c !== o && !c.$stable || a && t.$scopedSlots.$key !== a.$key || !a && t.$scopedSlots.$key),
                                            u = !!(i || // has new static slots
                                                t.$options._renderChildren || // has old static slots
                                                s),
                                            l = t.$vnode;
                                        t.$options._parentVnode = r, t.$vnode = r, // update vm's placeholder node without re-render
                                            t._vnode && (
                                        ...
                                        t._attrsProxy && un(t._attrsProxy, f, l.data && l.data.attrs || o, t, "$attrs") && (u = !0), t.$attrs = f,
                                            // update listeners
                                            n = n || o;
                                        var d = t.$options._parentListeners;
                                        // update props
                                        if (t._listenersProxy && un(t._listenersProxy, n, d || o, t, "$listeners"), t.$listeners = t.$options._parentListeners = n, pr(t, n, d), e && t.$options.props) {
                                            Tt(!1);
                                            for (var p = t._props, v = t.$options._propKeys || [], h = 0; h < v.length; h++) {
                                                var g = v[h],
                                                    m = t.$options.props; // wtf flow?
                                                p[g] = Yr(g, m, e, t)
                                            }
                                            Tt(!0),
                                    ...
                                    }(e.componentInstance = t.componentInstance, n.propsData, // updated props
                                ...
                                insert: function(t) {
                                    ...
                                    r._isMounted || (r._isMounted = !0, _r(r, "mounted")), t.data.keepAlive && (n._isMounted ? (
                                        // vue-router#1212
                                        ...
                                        (e = r)._inactive = !1, wr.push(e)) : mr(r, !0 /* direct */ ))
                                },
                                destroy: function(t) {
                            ...
                            if (!a(t)) {
                                ...
                                if (f(t) && (t = l.extend(t)), "function" == typeof t) {
                                    ...
                                    if (a(t.cid) && (t = function(t, e) {
                                            ...
                                            var n = mn;
                                            if (n && c(t.owners) && -1 === t.owners.indexOf(n) &&
                                                // already pending
                                                t.owners.push(n), s(t.loading) && c(t.loadingComp)) return t.loadingComp;
                                            if (n && !c(t.owners)) {
                                                var r = t.owners = [n],
                                                    o = !0,
                                                    i = null,
                                    ...
                                    // @ts-expect-error
                                    if (s(t.options.functional)) return function(t, e, n, r, a) {
                                        var s = t.options,
                                            u = {},
                                            l = s.props;
                                        if (c(l))
                                            for (var f in l) u[f] = Yr(f, l, e || o);
                                        else c(n.attrs) && Nr(u, n.attrs), c(n.props) && Nr(u, n.props);
                                        var d = new Lr(n, u, a, r, t),
                                            p = s.render.call(null, d._c, d);
                                        if (p instanceof gt) return Ar(p, n, d.parent, s);
                                        if (i(p)) {
                                            for (var v = De(p) || [], h = new Array(v.length), g = 0; g < v.length; g++) h[g] = Ar(v[g], n, d.parent, s);
                                            return h
                                        }
                                    }(t, p, e, n, r);
                        ...
                        function Ur(t, e, n) {
                            ...
                            for (var r, o, i, a = dt ? Reflect.ownKeys(e) : Object.keys(e), c = 0; c < a.length; c++)
                                ...
                                "__ob__" !== (r = a[c]) && (o = t[r], i = e[r], n && S(t, r) ? o !== i && p(o) && p(i) && Ur(o, i) : Dt(t, r, i));
                            return t
                        }
                        /**
                         * Data
                        ...
                        function Vr(t, e, n) {
                            return n ? function() {
                                ...
                                e ? t ? function() {
                                    return Ur(l(e) ? e.call(this, this) : e, l(t) ? t.call(this, this) : t)
                                } : e : t
                        }
                        /**
                        ...
                        Gr.data = function(t, e, n) {
                            ...
                            Gr.watch = function(t, e, n, r) {
                                ...
                                if (
                                    ...
                                    t === it && (t = void 0),
                                    //@ts-expect-error work around
                                    e === it && (e = void 0), !e) return Object.create(t || null);
                                if (!t) return e;
                                var o = {};
                             ...
                             * Other object hashes.
                             */
                            Gr.props = Gr.methods = Gr.inject = Gr.computed = function(t, e, n, r) {
                                if (!t) return e;
                                ...
                                return t ? function() {
                                    ...
                                    return Ur(n, l(t) ? t.call(this) : t), e && Ur(n, l(e) ? e.call(this) : e, !1), n
                                } : e
                            };
                        /**
                         * Default strategy.
                            ...
                            if (l(e) && (
                                ...
                                function(t) {
                                    ...
                                    if (e) {
                                        var n, r, o = {};
                                        if (i(e))
                                            for (n = e.length; n--;) "string" == typeof(r = e[n]) && (o[I(r)] = {
                                                type: null
                                            });
                                        else if (p(e))
                                            for (var a in e) r = e[a], o[I(a)] = p(r) ? r : {
                                                type: r
                                            };
                                        t.props = o
                                    }
                        ...
                        function ro(t) {
                            ...
                            e.computed && function(t, e) {
                                ...
                                for (var n in e) {
                                    var r = e[n];
                                    if (i(r))
                                        for (var o = 0; o < r.length; o++) so(t, n, r[o]);
                                    else so(t, n, r)
                                }
                            }(t, e.watch)
                        }
                        ...
                        function io(t, e, n) {
                            var r = !st();
                            l(n) ? (eo.get = r ? ao(e) : co(n), eo.set = N) : (eo.get = n.get ? r && !1 !== n.cache ? ao(e) : co(n.get) : N, eo.set = n.set || N), Object.defineProperty(t, e, eo)
                        }
                        ...
                        function lo(t) {
                            ...
                            if (t.super) {
                                ...
                                if (n !== t.superOptions) {
                                    ...
                                    r && L(t.extendOptions, r), (e = t.options = qr(n, t.extendOptions)).name && (e.components[e.name] = t)
                                }
                            }
                            return e
                        }
                        ...
                        function po(t) {
                            ...
                            t.extend = function(t) {
                                ...
                                return (a.prototype = Object.create(n.prototype)).constructor = a, a.cid = e++, a.options = qr(n.options, t), a.super = n,
                        ...
                        function mo(t, e, n, r) {
                            ...
                            !o || r && o.tag === r.tag ||
                                ...
                                o.componentInstance.$destroy(), t[e] = null, O(n, e)
                        }! function(t) {
                            t.prototype._init = function(t) {
                                var e = this;
                                // a uid
                                e._uid = uo++,
                                    ...
                                    }(e, t) : e.$options = qr(lo(e.constructor), t || {}, e)
                                    /* istanbul ignore else */
                                    , e._renderProxy = e,
                                    // expose real self
                                    e._self = e,
                                    ...
                                    }(e), _r(e, "beforeCreate", void 0, !1 /* setContext */ ),
                                    function(t) {
                                    ...
                                    function(t) {
                                        ...
                                        if (e) {
                                            ...
                                            if (!f(n)) return;
                                            for (var r = Pe(t), o = dt ? Reflect.ownKeys(n) : Object.keys(n), i = 0
                                    ...
                                    _r(e, "created"), e.$options.el && e.$mount(e.$options.el)
                            }
                        }(fo),
                        //@ts-expect-error Vue has function type
                        function(t) {
                        ...
                        function(t) {
                            ...
                            t.prototype.$on = function(t, n) {
                                ...
                                if (n) {
                                    n = n.length > 1 ? T(n) : n;
                                    for (var r = T(arguments, 1), o = 'event handler for "'.concat(t, '"'), i = 0, a = n.length; i < a; i++) jn(n[i], e, r, e, o)
                                }
                                return e
                            }
                        }(fo),
                        ...
                        function(t) {
                            ...
                            tn(t.prototype), t.prototype.$nextTick = function(t) {
                                ...
                                var t = this,
                                    ...
                                    n = e.render,
                                    r = e._parentVnode;
                                r && t._isMounted && (t.$scopedSlots = on(t.$parent, r.data.scopedSlots, t.$slots, t.$scopedSlots), t._slotsProxy && fn(t._slotsProxy, t.$scopedSlots)),
                                ...
                                var o, a = pt,
                                    c = mn;
                                try {
                                    ht(t), mn = t, o = n.call(t._renderProxy, t.$createElement)
                                } catch (e) {
                                ...
                                KeepAlive: {
                                        ...
                                        cacheVNode: function() {
                                            ...
                                            if (r) {
                                                ...
                                                e[o] = {
                                                    ...
                                                    // prune oldest entry
                                                    this.max && n.length > parseInt(this.max) && mo(e, n[0], n, this._vnode), this.vnodeToCache = null
                                            }
                                        }
                                    },
                                    created: function() {
                                    ...
                                    render: function() {
                                        ...
                                        if (n) {
                                            ...
                                            var a = this.cache,
                                                c = this.keys,
                                                s = null == e.key ? // same constructor may get registered as different local components
                                                // so cid alone is not enough (#3269)
                                                n.Ctor.cid + (n.tag ? "::".concat(n.tag) : "") : e.key;
                        ...
                        ! function(t) {
                            ...
                            Object.defineProperty(t, "config", e),
                                ...
                                t.util = {
                                    ...
                                    mergeOptions: qr,
                                    defineReactive: Rt
                                }, t.set = Dt, t.delete = Mt, t.nextTick = Mn,
                                ...
                                t.options._base = t, L(t.options.components, _o),
                                function(t) {
                                    t.use = function(t) {
                                ...
                                function(t) {
                                    ...
                                    U.forEach((function(e) {
                                        ...
                                        t[e] = function(t, n) {
                                            return n ? ("component" === e && p(n) && (
                                                // @ts-expect-error
                                                n.name = n.name || t, n = this.options._base.extend(n)), "directive" === e && l(n) && (n = {
                                                bind: n,
                                                update: n
                        ...
                        var bo = b("style,class"),
                            ...
                            So = function(t, e) {
                                return $o(e) || "false" === e ? "false" : // allow arbitrary string value for contenteditable
                                    "contenteditable" === t && Co(e) ? e : "true"
                            },
                            xo = b("allowfullscreen,async,autofocus,autoplay,checked,compact,controls,declare,default,defaultchecked,defaultmuted,defaultselected,defer,disabled,enabled,formnovalidate,hidden,indeterminate,inert,ismap,itemscope,loop,multiple,muted,nohref,noresize,noshade,novalidate,nowrap,open,pauseonexit,readonly,required,reversed,scoped,seamless,selected,sortable,truespeed,typemustmatch,visible"),
                        ...
                        function Lo(t) {
                            return Array.isArray(t) ? function(t) {
                                for (var e, n = "", r = 0, o = t.length; r < o; r++) c(e = Lo(t[r])) && "" !== e && (n && (n += " "), n += e);
                                return n
                            }(t) : f(t) ? function(t) {
                                var e = "";
                            ...
                            if (c(n)) {
                                ...
                                if (l(n)) jn(n, r, [a], r, "template ref function");
                                    ...
                                    if (f || d)
                                        if (u) {
                                            var v = f ? p[n] : n.value;
                                            e ? i(v) && O(v, o) : i(v) ? v.includes(o) || v.push(o) : f ? (p[n] = [o], Uo(r, n, p[n])) : n.value = [o]
                                        } else if (f) {
                                        if (e && p[n] !== o) return;
                                        p[n] = s, Uo(r, n, a)
                                    } else if (d) {
                        ...
                        function Zo(t, e) {
                            ...
                            for (n = 0; n < t.length; n++) {
                                if ((r = t[n]).modifiers || (
                                        // $flow-disable-line
                                        r.modifiers = Yo), o[Xo(r)] = r, e._setupState && e._setupState.__sfc) {
                        ...
                        function ei(t, e) {
                            ...
                            if (!(c(n) && !1 === n.Ctor.options.inheritAttrs || a(t.data.attrs) && a(e.data.attrs))) {
                                ...
                                /* istanbul ignore if */
                                for (r in (Q || et) && l.value !== u.value && ni(i, "value", l.value), u) a(l[r]) && (Io(r) ? i.removeAttributeNS(jo, ko(r)) : Oo(r) || i.removeAttribute(r))
                            }
                        }

                        function ni(t, e, n, r) {
                            r || t.tagName.indexOf("-") > -1 ? ri(t, e, n) : xo(e) ?
                                // set attribute for blank value
                                // e.g. <option disabled>Select one</option>
                                $o(n) ? t.removeAttribute(e) : (
                                    // technically allowfullscreen is a boolean attribute for <iframe>,
                                    // but Flash expects a value of "true" when used on <embed> tag
                                    n = "allowfullscreen" === e && "EMBED" === t.tagName ? "true" : e, t.setAttribute(e, n)) : Oo(e) ? t.setAttribute(e, So(e, n)) : Io(e) ? $o(n) ? t.removeAttributeNS(jo, ko(e)) : t.setAttributeNS(jo, e, n) : ri(t, e, n)
                        }

                        function ri(t, e, n) {
                            if ($o(n)) t.removeAttribute(e);
                            else {
                            ...
                            if (fi) {
                                ...
                                e = i._wrapper = function(t) {
                                    if (
                                        ...
                                        // starting reference
                                        t.target.ownerDocument !== document) return i.apply(this, arguments)
                                }
                            }
                            ai.addEventListener(t, e, at ? {
                                capture: n,
                                passive: r
                            } : n)
                        }
                            ...
                            if (!a(t.data.on) || !a(e.data.on)) {
                                ...
                                ai = e.elm || t.elm,
                                    ...
                                    function(t) {
                                        ...
                                        /* istanbul ignore if */
                                        c(t[ui]) && (t.change = [].concat(t[ui], t.change || []), delete t[ui])
                                    }(n), Ae(n, r, di, pi, li, e.context), ai = void 0
                            }
                        }
                        var hi, gi = {
                            create: vi,
                        ...
                        function mi(t, e) {
                            if (!a(t.data.domProps) || !a(e.data.domProps)) {
                                ...
                                for (n in
                                    // clone observed objects, as the user probably wants to mutate it
                                    (c(u.__ob__) || s(u._v_attr_proxy)) && (u = e.data.domProps = L({}, u)), i) n in u || (o[n] = "");
                                for (n in u) {
                        ...
                        var Ci, Si = /^--/,
                            ...
                            Ii = ["Webkit", "Moz", "ms"],
                            ki = x((function(t) {
                                if (Ci = Ci || document.createElement("div").style, "filter" !== (t = I(t)) && t in Ci) return t;
                        ...
                        function $i(t, e) {
                            ...
                            if (!(a(n.staticStyle) && a(n.style) && a(r.staticStyle) && a(r.style))) {
                                ...
                                // to mutate it.
                                e.data.normalizedStyle = c(d.__ob__) ? L({}, d) : d;
                                var p = function(t, e) {
                                    var n, r = {};
                                    if (e)
                                        for (var o = t; o.componentInstance;)(o = o.componentInstance._vnode) && o.data && (n = wi(o.data)) && L(r, n);
                                    (n = wi(t.data)) && L(r, n);
                                    // @ts-expect-error parentNode.parent not VNodeWithData
                                    for (var i = t; i = i.parent;) i.data && (n = wi(i.data)) && L(r, n);
                                    return r
                                }(e, !0);
                        ...
                        function Ai(t) {
                            if (t) {
                                ...
                                if ("object" == typeof t) {
                                    var e = {};
                                    return !1 !== t.css && L(e, Ni(t.name || "v")), L(e, t), e
                                }
                        ...
                        var Ui = Z ? window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout : /* istanbul ignore next */ function( /* istanbul ignore next */ t) {
                            return t()
                        };
                        ...
                        function Hi(t, e) {
                            t._transitionClasses && O(t._transitionClasses, e), Li(t, e)
                        }
                        ...
                        function Ki(t, e) {
                            ...
                            /* istanbul ignore if */
                            return e === Di ? a > 0 && (n = Di, l = a, f = i.length) : e === Mi ? u > 0 && (n = Mi, l = u, f = s.length) : f = (n = (l = Math.max(a, u)) > 0 ? a > u ? Di : Mi : null) ? n === Di ? i.length : s.length : 0, {
                                type: n,
                                timeout: l,
                                propCount: f,
                                hasTransform: n === Di && qi.test(r[zi + "Property"])
                            }
                        }
                                ...
                                if (!k || O || "" === O) {
                                    ...
                                    var D = !1 !== o && !tt,
                                        ...
                                        z = n._enterCb = B((function() {
                                            D && (Hi(n, E), Hi(n, P)),
                                                // @ts-expect-error
                                                z.cancelled ? (D && Hi(n, $), N && N(n)) : A && A(n), n._enterCb = null
                                        }));
                                    t.data.show ||
                                        ...
                                        T && T(n), D && (Wi(n, $), Wi(n, P), Vi((function() {
                                            Hi(n, $),
                                                // @ts-expect-error
                                                z.cancelled || (Wi(n, E), M || (ta(R) ? setTimeout(z, R) : Ji(n, i, z)))
                                        }))), t.data.show && (e && e(), L && L(n, z)), D || M || z()
                                }
                            }
                        }
                        ...
                        function Qi(t, e) {
                            ...
                            if (!c(n._leaveCb)) {
                                ...
                                var O = n._leaveCb = B((function() {
                                    n.parentNode && n.parentNode._pending && (n.parentNode._pending[t.key] = null), y && (Hi(n, u), Hi(n, l)),
                                        // @ts-expect-error
                                        O.cancelled ? (y && Hi(n, s), h && h(n)) : (e(), v && v(n)), n._leaveCb = null
                                }));
                                g ? g(C) : C()
                            }
                            ...
                            function C() {
                                ...
                                O.cancelled || (
                                    ...
                                    !t.data.show && n.parentNode && ((n.parentNode._pending || (n.parentNode._pending = {}))[t.key] = t), d && d(n), y && (Wi(n, s), Wi(n, l), Vi((function() {
                                        Hi(n, s),
                                            // @ts-expect-error
                        ...
                        var ra = function(t) {
                            ...
                            for (e = 0; e < Wo.length; ++e)
                                for (r[Wo[e]] = [], n = 0; n < o.length; ++n) c(o[n][Wo[e]]) && r[Wo[e]].push(o[n][Wo[e]]);
                            ...
                            function d(t, e, n, o, i, a, u) { // for transition enter check
                                if (c(t.elm) && c(a) && (
                                        ...
                                        t = a[u] = _t(t)), t.isRootInsert = !i, ! function(t, e, n, o) {
                                        var i = t.data;
                                        if (c(i)) {
                                            ...
                                            if (c(i = i.hook) && c(i = i.init) && i(t, !1 /* hydrating */ ), c(t.componentInstance)) return p(t, e), v(n, t.elm, o), s(a) && function(t, e, n, o) {
                                                var i, a = t;
                                    ...
                                    var f = t.data,
                                        d = t.children,
                                        g = t.tag;
                                    c(g) ? (t.elm = t.ns ? l.createElementNS(t.ns, g) : l.createElement(g, t), y(t), h(t, d, e), c(f) && m(t, e), v(n, t.elm, o)) : s(t.isComment) ? (t.elm = l.createComment(t.text), v(n, t.elm, o)) : (t.elm = l.createTextNode(t.text), v(n, t.elm, o))
                                }
                            }

                            function p(t, e) {
                                c(t.data.pendingInsert) && (e.push.apply(e, t.data.pendingInsert), t.data.pendingInsert = null), t.elm = t.componentInstance.$el, g(t) ? (m(t, e), y(t)) : (
                            ...
                            function y(t) {
                                ...
                                if (c(e = t.fnScopeId)) l.setStyleScope(t.elm, e);
                                    ...
                                    for (var n = t; n;) c(e = n.context) && c(e = e.$options._scopeId) && l.setStyleScope(t.elm, e), n = n.parent;
                            ...
                            function C(t, e) {
                                if (c(e) || c(t.data)) {
                                    ...
                                    for (c(e) ?
                                        ...
                                        c(n = t.componentInstance) && c(n = n._vnode) && c(n.data) && C(n, e), n = 0; n < r.remove.length; ++n) r.remove[n](t, e);
                            ...
                            function x(t, e, n, o, i, u) {
                                if (t !== e) {
                                    c(e.elm) && c(o) && (
                                        ...
                                        e = o[i] = _t(e));
                                    var f = e.elm = t.elm;
                                    if (s(t.isAsyncPlaceholder)) c(e.asyncFactory.resolved) ? k(t.elm, e, n) : e.isAsyncPlaceholder = !0;
                                    else
                                        // reuse element for static trees.
                                        // note we only do this if the vnode is cloned -
                                        // if the new node is not cloned it means the render functions have been
                                        // reset by the hot-reload-api and we need to do a proper re-render.
                                        if (s(e.isStatic) && s(t.isStatic) && e.key === t.key && (s(e.isCloned) || s(e.isOnce))) e.componentInstance = t.componentInstance;
                                        else {
                                            var p, v = e.data;
                                            ...
                                            a(e.text) ? c(h) && c(m) ? h !== m && function(t, e, n, r, o) {
                                                var i, s, u, f = 0,
                                                    p = 0,
                                                    v = e.length - 1,
                                                    h = e[0],
                                                    ...
                                                    b = n[m],
                                                    w = !o;
                                                for (; f <= v && p <= m;) a(h) ? h = e[++f] : a(g) ? g = e[--v] : Ho(h, y) ? (x(h, y, r, n, p), h = e[++f], y = n[++p]) : Ho(g, b) ? (x(g, b, r, n, m), g = e[--v], b = n[--m]) : Ho(h, b) ? (
                                                    // Vnode moved right
                                                    ...
                                                    d(y, r, t, h.elm, !1, n, p), y = n[++p]);
                                                f > v ? _(t, a(n[m + 1]) ? null : n[m + 1].elm, n, p, m, r) : p > m && O(e, f, v)
                                            }(f, h, m, n, u) : c(m) ? (c(t.text) && l.setTextContent(f, ""), _(f, null, m, 0, m.length - 1, n)) : c(h) ? O(h, 0, h.length - 1) : c(t.text) && l.setTextContent(f, "") : t.text !== e.text && l.setTextContent(f, e.text), c(v) && c(p = v.hook) && c(p = p.postpatch) && p(t, e)
                                        }
                                }
                            }
                                        ...
                                        if (!p && Ho(t, e))
                                            ...
                                            if (
                                                ...
                                                d(e, f,
                                                    ...
                                                    v._leaveCb ? null : h, l.nextSibling(v)), c(e.parent))
                                                for (var m = e.parent, y = g(e); m;) {
                                                    for (var _ = 0; _ < r.destroy.length; ++_) r.destroy[_](m);
                                                    if (m.elm = e.elm, y) {
                                                        for (var b = 0; b < r.create.length; ++b) r.create[b](Vo, m);
                                                        // #6513
                                                        ...
                                                        if (C.merged)
                                                            for (
                                                                ...
                                                                var S = C.fns.slice(1), I = 0; I < S.length; I++) S[I]()
                                                    } else Go(m);
                                                    m = m.parent
                                                }
                                            // destroy old node
                        ...
                        var oa = {
                            inserted: function(t, e, n, r) {
                                "select" === n.tag ? (
                                    // #6903
                                    r.elm && !r.elm._vOptions ? Ne(n, "postpatch", (function() {
                                        oa.componentUpdated(t, e, n)
                                    })) : ia(t, e, n.context), t._vOptions = [].map.call(t.options, sa)) : ("textarea" === n.tag || zo(t.type)) && (t._vModifiers = e.modifiers, e.modifiers.lazy || (t.addEventListener("compositionstart", ua), t.addEventListener("compositionend", la),
                        ...
                        var pa = {
                                ...
                                update: function(t, e, n) {
                                    var r = e.value;
                                    /* istanbul ignore if */
                                    !r != !e.oldValue && ((n = da(n)).data && n.data.transition ? (n.data.show = !0, r ? Xi(n, (function() {
                        ...
                        function ga(t) {
                            ...
                            return e && e.Ctor.options.abstract ? ga(_n(e.children)) : t
                        }
                            ...
                            wa = {
                                ...
                                render: function(t) {
                                    ...
                                    /* istanbul ignore if */
                                    {
                                        ...
                                        var c = (i.data || (i.data = {})).transition = ma(this),
                                            s = this._vnode,
                                            l = ga(s);
                                        if (
                                            // mark v-show
                                            // so that the transition module can hand over the control to the directive
                                            i.data.directives && i.data.directives.some(ba) && (i.data.show = !0), l && l.data && ! function(t, e) {
                                            ...
                                            if ("out-in" === r)
                                                ...
                                                return this._leaving = !0, Ne(f, "afterLeave", (function() {
                            ...
                            beforeMount: function() {
                                ...
                                this._update = function(n, r) {
                                    ...
                                    t.__patch__(t._vnode, t.kept, !1, // hydrating
                                        !0), t._vnode = t.kept, o(), e.call(t, n, r)
                                }
                            },
                            render: function(t) {
                                for (var e = this.tag || this.$vnode.data.tag || "span", n = Object.create(null), r = this.prevChildren = this.children, o = this.$slots.default || [], i = this.children = [], a = ma(this), c = 0; c < o.length; c++) {
                                    if ((l = o[c]).tag)
                                ...
                                if (r) {
                                    ...
                                    for (c = 0; c < r.length; c++) {
                                        ...
                                        (l = r[c]).data.transition = a,
                                            ...
                                            l.data.pos = l.elm.getBoundingClientRect(), n[l.key] ? s.push(l) : u.push(l)
                                    }
                                ...
                                t.length && this.hasMove(t[0].elm, e) && (
                                    ...
                                    this._reflow = document.body.offsetHeight, t.forEach((function(t) {
                                        if (t.data.moved) {
                                            var n = t.elm,
                                                r = n.style;
                                            Wi(n, e), r.transform = r.WebkitTransform = r.transitionDuration = "", n.addEventListener(Bi, n._moveCb = function t(r) {
                                                r && r.target !== n || r && !/transform$/.test(r.propertyName) || (n.removeEventListener(Bi, t), n._moveCb = null, Hi(n, e))
                                            })
                                        }
                                    })))
                            },
                        ...
                        fo.config.mustUseProp = function(t, e, n) {
                            ...
                            }, fo.config.isReservedTag = Do, fo.config.isReservedAttr = bo, fo.config.getTagNamespace = function(t) {
                                return Ro(t) ? "svg" :
                            ...
                            fo.prototype.$mount = function(t, e) {
                                return function(t, e, n) {
                                    var r;
                                    /* istanbul ignore if */
                                    t.$el = e, t.$options.render || (
                                            // @ts-expect-error invalid type
                                            t.$options.render = mt), _r(t, "beforeMount"), r = function() {
        ...
        49:
            ...
            function(t, e, n) {
                ...
                var r = n(4),
                    o = n(15),
                    i = n(13),
                    a = (n(36), n(22), n(21), n(27), n(14), n(56), n(93), n(41), n(16), n(553), n(255), n(136), n(25), n(24), n(20), n(183), n(6), n(8), n(9), n(11), n(12), n(3)),
                    c = n(91),
                    s = n.n(c),
                    u = n(380),
                    l = n(181),
                ...
                function b(t) {
                    if (w(t) > 0) {
                        var e = t.split(".")[1].replace(/-/g, "+").replace(/_/g, "/"),
                            n = decodeURIComponent(atob(e).split("").map((function(t) {
                 ...
                 */
                function O(t, e) {
                    var n, r, o = (r = (n = location.hostname).indexOf(":"), /[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}/.test(n) ? r > -1 ? n.substring(0, r) : n : r > -1 ? n.substring(n.indexOf(".") + 1, r) : n.substring(n.indexOf(".") + 1)),
                        i = e;
                ...
                e.b = function(t, e) {
                    ...
                    function m(t, e) {
                        var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                            ...
                            function() {
                                ...
                                // 'en-US':正常,
                                // 'vi-VN':相反
                                return "" === r.getters.thousandThMode && ["vi-VN", "es-AR", "pt-BR", "it-IT", "sv-SE", "de-DE", "da-DK", "ro-RO", "fr-FR", "gr-GR", "nl-NL", "tr-TR"].includes(r.getters.lang) && (t = ".", e = ","), "vi-VN" === r.getters.thousandThMode && (t = ".", e = ","), {
                                    commaSymbol: t,
                                    pointSymbol: e
                                }
                            }(),
                        ...
                        if (w(t) > 0) {
                            ...
                            (s = "string" == typeof t ? t.split(".") : t.toString().split("."))[0] = s[0].replace(/\B(?=(\d{3})+(?!\d))/g, i),
                                ...
                                1 === s.length && n && (s[1] = "0".repeat(e)), c = s.join(a)
                        }
                        return c
                    }
                    /**
                    ...
                    var j = new Map([
                        ["tx", ["zh-CN", "zh-TW", "vi-VN"]],
                        ["lj", ["zh-CN", "zh-TW", "pt-BR"]],
                        ["lj2", ["zh-CN", "zh-TW", "pt-BR"]],
                        ["lt", ["zh-CN", "zh-TW", "pt-BR"]],
                        ["lm", ["zh-CN", "zh-TW", "pt-BR"]],
                        ["col", ["zh-CN", "zh-TW", "es-AR"]],
                        ["clb", ["zh-CN", "zh-TW", "pt-BR", "tr-TR"]],
                        ["yg500", ["zh-CN", "zh-TW", "pt-BR"]],
                        ["lj500", ["zh-CN", "zh-TW", "pt-BR"]],
                        ["bt", ["zh-CN", "zh-TW", "pt-BR"]]
                    ]);

                    function I(t, e) {
                        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "en-US";
                        return (j.get(t) || ["zh-CN", "zh-TW"]).includes(e) ? e : n
                    }
                    var k = new Map([
                            ["tada", new Set(["cashballoon"])],
                            ["jili", new Set(["cashballoon"])]
                        ]),
                        $ = new Map([
                            ["tada", "_tada"],
                            ["jili", "_jili"]
                    ...
                    function E(t, e, n) {
                        var r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3],
                            o = "";
                        // 處理品牌要顯示什麼
                        if (P.has(t)) o = P.get(t)({
                            brand: e,
                            apiId: n
                        });
                        else if (!r && k.has(e)) {
                            k.get(e).has(t) && (o = $.get(e) || "")
                        }
                        return o
                    }
                    /**
                    ...
                    function T(t, e, n, o, i) {
                        ...
                        if (
                            ...
                            // 是否要強制指定顯示幾個小數位數
                            null != o && (s = o), null != t && null != u && u.length > 0) {
                    ...
                    function L(t) {
                        ...
                        return 7 === e.length ? {
                            type: e.substring(0, 1),
                            gameId: e.substring(1, 4),
                            starLevel: e.substring(4, 5),
                            cardSerialNo: e.substring(5)
                        } : {}
                    }
                    /**
                     * 判斷魚機卡片是否為例外
                    ...
                    function N(t) {
                        ...
                        return i && (r = r.abs()), r.gte(1e12) && a.t ? (r = parseFloat(r.div(1e12).toFixed(e, 0)), o = "T") : r.gte(1e9) && a.b ? (r = parseFloat(r.div(1e9).toFixed(e, 0)), o = "B") : r.gte(1e6) && a.m ? (r = parseFloat(r.div(1e6).toFixed(e, 0)), o = "M") : r.gte(1e3) && a.k && (r = parseFloat(r.div(1e3).toFixed(e, 0)), o = "K"), i && (r *= -1), m(r.toString(), e) + o
                    }
                    /**
                    ...
                    function D(t) {
                        ...
                        // 節慶樣式
                        var o = e.festival;
                        if (null != Object(g.d)(t, o, g.b)) return "".concat(g.b, "-").concat(o);
                        // 舊規格樣式
                        var a = e.symbolstyle || e.style || r.state.style.default;
                        if (a) {
                            var c = parseInt(a, 10),
                                s = c >= 100 ? g.a : g.b,
                                u = s === g.a ? (c / 100).toString() : a;
                            if (null != Object(g.d)(t, u, s)) return "".concat(s, "-").concat(u)
                        }
                        return ""
                    }
                    ...
                    var M = {
                        ...
                        getGameIconUrl: function(t, e, n) {
                                var o = e || 3,
                                    i = Object(f.a)(t),
                                    a = I(i, n),
                                    c = E(i, r.state.gameIconBrandFilename, r.getters.apiId);
                                return "/images/gamehistory/".concat(i, "/icon").concat(o, "/icon_").concat(a).concat(c, ".png")
                            }
                            /**
                             * 取得遊戲 icon 網址
                             * @param {number} gameId
                        ...
                        getGameIconUrlBySymbolStyle:
                            ...
                            function(t, e, n, o) {
                                var i = e || 3,
                                    a = Object(f.a)(t),
                                    c = I(a, n),
                                    s = E(a, r.state.gameIconBrandFilename, r.getters.apiId, !0);
                                return "/images/gamehistory/".concat(a, "/symbol-style-").concat(o, "/icon").concat(i, "/icon_").concat(c).concat(s, ".png")
                            }
                            /**
                             * 取得css變數或設定css變數
                             * @param {string} name
                        ...
                        getGameIconUrlByStyle: function(t, e, n, o) {
                            var i = e || 3,
                                ...
                                c = I(a, n),
                                s = E(a, r.state.gameIconBrandFilename, r.getters.apiId, !0);
                            return "/images/gamehistory/".concat(a, "/style-").concat(o, "/icon").concat(i, "/icon_").concat(c).concat(s, ".png")
                        },
                        getCurrencyDisplay: T,
                        getJwtCurrencyDisplay: function(t, e, n, r) {
                                return T(null, t, 0, n, r)
                            }
                        ...
                        getCurrencyRatioDisplay: function(t, e) {
                            ...
                            ,
                        cssVar: function(t, e) {
                            return "-" !== t[0] && (t = "--" + t), // allow passing with or without --
                                (e || null === e) && document.documentElement.style.setProperty(t, e), getComputedStyle(document.documentElement).getPropertyValue(t)
                        },
                        isEmpty:
                            /**
                             * 是否為空物件
                            ...
                            ,
                        merge: s.a,
                        mergeWithOverwriteArray: Object.assign((function(t, e) {
                            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                            return s()(t, e, y({
                                arrayMerge: R
                            }, n))
                        ...
                        getFishCardDescId: function(t, e) {
                            ...
                            return "1" === c && (r = !0, o = !0),
                                ...
                                "6" === c && (n = !0, r = !0, o = !0),
                                // 三種顏色的鑽頭
                                "7" === c && ["01", "02", "03"].includes(l) && (n = !0, r = !0, o = !0), i = c + (n ? "000" : s), i += r ? "1" : u, "i18_FishingCardDesc_" + (i += o ? "01" : l)
                        },
                        imageUrl: function(t) {
                        ...
                        getGameUrl: function() {
                                ...
                                if (o.GAME_URL) t = o.GAME_URL;
                                    ...
                                    // 印度 webapp 特規
                                    t = "webapp" === r.state.device && "IN" === r.state.webId ? "https://" + e.replace("history.", "www.") : "https://" + e.replace("www.", "wbgame.").replace("history.", "wbgame.")
                                }
                                return t
                            }
                            /**
                        ...
                        formatNumberKM: function(t) {
                            var e = p()(t),
                                n = "";
                            return e.gte(1e6) ? (e = e.div(1e6), n = "m") : e.gte(1e3) && (e = e.div(1e3), n = "k"), m(e.toString()) + n
                        },
                        formatNumberKMBT: N,
                        formatNumberIDR: function(t) {
                                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                                    n = arguments.length > 2 ? arguments[2] : void 0,
                                    r = p()(t),
                                    o = "",
                                ...
                                return i && (r = r.abs()), r.gte(1e9) && a.m ? (r = parseFloat(r.div(1e9).toFixed(e, 0)), o = "M") : r.gte(1e6) && a.jt ? (r = parseFloat(r.div(1e6).toFixed(e, 0)), o = "jt") : r.gte(1e3) && a.rb && (r = parseFloat(r.div(1e3).toFixed(e, 0)), o = "rb"), i && (r *= -1), m(r.toString(), e) + o
                            }
                            /**
                             * 將數字無條件捨去至小數點第二位
                             * @param {Number} number
                        ...
                        getFixTo2Number: function(t) {
                            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 2,
                                n = t;
                            return n = "".concat(p()(n || 0).round(e, 0).toFixed(e).toString())
                        },
                        getStyleName: D
                    };
                    e("utils", M)
