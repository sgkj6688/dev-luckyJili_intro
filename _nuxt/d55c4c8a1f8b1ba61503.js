                                    ...
                                    switch ((t.prev = t.next)) {
                                        case 0:
                                            return (
                                                ...
                                                (p = {}), // 動態導入所需模組
                                                (t.next = 4),
                                                Promise.resolve().then(n.t.bind(null, 223, 7))
                                            );
                                        case 4:
                                            return (
                                                (v = t.sent),
                                                (h = v.default),
                                                (t.next = 8),
                                                Promise.all(/* import() */ [n.e(1), n.e(0), n.e(2)]).then(n.bind(null, 256))
                                            );
                                        case 8:
                                            ((g = t.sent),
                                                (m = g.isArray),
                                                (y = g.isObject), // 需要連線自簽憑證時才需要，目前都直接連測試機，固不需要
                                                ...
                                                (p.getMarquee = function (t, e) {
                                                    return Object(a.a)(d.WEB_ID, "getMarquee")
                                                        ? _.get("/marquee/".concat(t, "/").concat(e))
                                                        : Promise.resolve([]);
                                                }),
                                                /**
                                                 * 取得輪播列表
                ...
                e.a = function (t, e) {
                    ...
                    (f.onRequest(function (t) {
                        ...
                        (d.isNicknameEnable = function () {
                            return Object(s.a)(l.WEB_ID, "isNicknameEnable")
                                ? f.get("/game-setting/is-enable/NickNameEnable")
                                : Promise.resolve({
                                      IsEnable: !1,
                                  });
                        }),
                        ...
                        (d.getHistoryRecord = function (t) {
                            ...
                            return (
                                ...
                                // }
                                null != m && (O.OffsetStartTime = m),
                                null != _ && (O.OffsetStartRowIndex = _),
                                null != w && (O.OffsetDbIndex = w),
                                f
                                    .get("/history/".concat(e, "/get-history-record"), {
                                        params: O,
                                    })
                                    .then(function (t) {
                                        return null == t
                        ...
                        (d.getGoHistoryRecord = function (t) {
                            ...
                            return (
                                ...
                                null != w && (O.OffsetDbIndex = w),
                                f
                                    .get("/v2/history/".concat(e, "/get-history-record"), {
                                        params: O,
                                    })
                                    .then(function (t) {
                                        return null == t
                        ...
                        (d.getDetailRecord = function (t, e, n, r, o, i, a) {
                            ...
                            return (
                                a && (c.LogIndex = a),
                                f
                                    .get("/history/".concat(t, "/get-detail-record"), {
                                        params: c,
                                    })
                                    .then(function (t) {
                                        return null == t ? [] : t;
                        ...
                        (d.getGoDetailRecord = function (t, e, n, r, o, i, a) {
                            ...
                            return (
                                a && (c.LogIndex = a),
                                f
                                    .get("/v2/history/".concat(t, "/get-detail-record"), {
                                        params: c,
                                    })
                                    .then(function (t) {
                                        return null == t ? [] : t;
                        ...
                        (d.getGoBingoInfo = function (t) {
                            var e = t.lang,
                                ...
                                r = t.roundIndex;
                            return f
                                .get("/v2/history/".concat(n, "/get-detail-info/").concat(e, "/").concat(r))
                                .then(function (t) {
                                    var e,
                                        n,
                                        r = a.$utils.merge({}, t);
                                    ...
                                    switch ((t.prev = t.next)) {
                                            ...
                                            if (
                                                ...
                                                (u = a.device) &&
                                                    ...
                                                    "webapp" === u.toLowerCase() &&
                                                        ...
                                                        r.commit("control/setHidePrizePage", !0),
                                                        r.commit("control/setUseAppVipContent", !0)),
                                                    "history_member" === u.toLowerCase() && r.commit("control/setHidePrizePage", !0),
                                                    "history_rewards" === u.toLowerCase() && r.commit("control/setHideMemberPage", !0),
                                                    "history_only" === u.toLowerCase() &&
                                                        (r.commit("control/setHideMemberPage", !0), r.commit("control/setHidePrizePage", !0)),
                                                    r.commit("SET_DEVICE", u)),
                                                // 依不同 apiId 調整網頁標題、網頁 icon、專案多語系標題、webid、遊戲 icon 廠牌名稱、logo 名稱
                                                // 印度目前以domain來區分
                                                "IN" === r.state.webId &&
                                                    location.hostname.includes("jilistar") &&
                                                    (l = Object(o.a)(202)) &&
                                                    r.commit("setVal", l),
                                        ...
                                        case 21:
                                            ...
                                            (a.posthost ? r.commit("control/setPostMessageHost", a.posthost) : r.commit("control/setPostMessageHost", ""),
                                                ...
                                                a.gp && r.commit("control/setHideMemberPage", !0),
                                                a.sac && r.commit("cookies/SET_SAC", +a.sac),
                                                // TaDaSSS 專用設定
                                                "TADA" === r.state.webId &&
                                                    a.game &&
                                                    ((d =
                                                        null === (f = r.state.gameSettings) || void 0 === f
                                                            ? void 0
                                                            : f.find(function (t) {
                                                                  return t.No === +a.game;
                                                              })),
                                                    (p = Object(o.a)(20002)),
                                                    d && d.Id.toLocaleLowerCase().startsWith("sss-") && p && r.commit("setVal", p)));
                                        case 25:
                                        case "end":
                                            return t.stop();
                                    }
                    ...
                    (window.onNuxtReady(
                        ...
                        window.addEventListener("message", function (t) {
                            ...
                            if (t.origin === i.getGameUrl()) {
                                ...
                                // 新指令
                                if ("refresh" === r.cmd)
                                    null !== (n = r.options) && void 0 !== n && n.stayLatestPage
                                        ? // 只刷新api
                                          window.$nuxt.refresh()
                                        : // 回到最初的 iframe 網址
                    ...
                    function (t, r) {
                        ...
                        ***************************************************************************** */
                        ...
                        function Pr() {
                            ...
                            for (jr = Ir(), Sr = !0, br.sort($r), xr = 0; xr < br.length; xr++)
                        ...
                        function io(t, e, n) {
                            var r = !st();
                            (l(n)
                                ? ((eo.get = r ? ao(e) : co(n)), (eo.set = N))
                                : ((eo.get = n.get ? (r && !1 !== n.cache ? ao(e) : co(n.get)) : N), (eo.set = n.set || N)),
                                        ...
                                        cacheVNode: function () {
                                            ...
                                            if (r) {
                                                ...
                                                ((e[o] = {
                                                    ...
                                                    n.push(o),
                                                    // prune oldest entry
                                                    this.max && n.length > parseInt(this.max) && mo(e, n[0], n, this._vnode),
                        ...
                        function ei(t, e) {
                            ...
                            if (!((c(n) && !1 === n.Ctor.options.inheritAttrs) || (a(t.data.attrs) && a(e.data.attrs)))) {
                                ...
                                for (r in ((c(l.__ob__) || s(l._v_attr_proxy)) && (l = e.data.attrs = L({}, l)), l))
                                    ((o = l[r]), u[r] !== o && ni(i, r, o, e.data.pre));
                                // #4391: in IE9, setting type can reset value for input[type=radio]
                                // #6666: IE/Edge forces progress value down to 1 before setting a max
                                /* istanbul ignore if */
                                for (r in ((Q || et) && l.value !== u.value && ni(i, "value", l.value), u))
                                    a(l[r]) && (Io(r) ? i.removeAttributeNS(jo, ko(r)) : Oo(r) || i.removeAttribute(r));
                            }
                        }
                        ...
                        function mi(t, e) {
                            if (!a(t.data.domProps) || !a(e.data.domProps)) {
                                var n,
                                    ...
                                    u = e.data.domProps || {};
                                // clone observed objects, as the user probably wants to mutate it
                                for (n in ((c(u.__ob__) || s(u._v_attr_proxy)) && (u = e.data.domProps = L({}, u)), i)) n in u || (o[n] = "");
                                for (n in u) {
                        ...
                        function $i(t, e) {
                            ...
                            if (!(a(n.staticStyle) && a(n.style) && a(r.staticStyle) && a(r.style))) {
                                ...
                                var p = (function (t, e) {
                                    var n,
                                        r = {};
                                    if (e) for (var o = t; o.componentInstance; ) (o = o.componentInstance._vnode) && o.data && (n = wi(o.data)) && L(r, n);
                                    (n = wi(t.data)) && L(r, n);
                                    // @ts-expect-error parentNode.parent not VNodeWithData
                        ...
                        Ri &&
                            ...
                            void 0 === window.onanimationend &&
                                ...
                                ((Fi = "WebkitAnimation"), (Gi = "webkitAnimationEnd")));
                                ...
                                if (!k || O || "" === O) {
                                    ...
                                    var D = !1 !== o && !tt,
                                        ...
                                        z = (n._enterCb = B(function () {
                                            (D && (Hi(n, E), Hi(n, P)),
                                                // @ts-expect-error
                                                z.cancelled ? (D && Hi(n, $), N && N(n)) : A && A(n),
                                                (n._enterCb = null));
                                        }));
                                    (t.data.show ||
                            ...
                            function d(t, e, n, o, i, a, u) {
                                ...
                                if (
                                    ...
                                    var f = t.data,
                                        ...
                                        g = t.tag;
                                    c(g)
                                        ? ((t.elm = t.ns ? l.createElementNS(t.ns, g) : l.createElement(g, t)),
                                          y(t),
                                          h(t, d, e),
                                          c(f) && m(t, e),
                                          v(n, t.elm, o))
                                    ...
                                    if (s(t.isAsyncPlaceholder)) c(e.asyncFactory.resolved) ? k(t.elm, e, n) : (e.isAsyncPlaceholder = !0);
                                        ...
                                        (a(e.text)
                                            ? c(h) && c(m)
                                                          ...
                                                          a(h)
                                                              ...
                                                              : a(g)
                                                                ...
                                                                : Ho(h, y)
                                                                  ...
                                                                  : Ho(g, b)
                                                                    ? (x(g, b, r, n, m), (g = e[--v]), (b = n[--m]))
                                                                    : Ho(h, b)
                                                                      ? // Vnode moved right
                                                                        (x(h, b, r, n, m),
                                                                        w && l.insertBefore(t, h.elm, l.nextSibling(g.elm)),
                                                                        (h = e[++f]),
                                                                        (b = n[--m]))
                                                                      : Ho(g, y)
                                                                        ? // Vnode moved left
                                                                          (x(g, y, r, n, p), w && l.insertBefore(t, g.elm, h.elm), (g = e[--v]), (y = n[++p]))
                                                                        : (a(i) && (i = Jo(e, f, v)),
                                                ...
                                                : c(m)
                                                  ? (c(t.text) && l.setTextContent(f, ""), _(f, null, m, 0, m.length - 1, n))
                                                  : c(h)
                                                    ? O(h, 0, h.length - 1)
                                        ...
                                        if (!p && Ho(t, e))
                                            ...
                                            if (p) {
                                                if (
                                                    ...
                                                    (1 === t.nodeType && t.hasAttribute(G) && (t.removeAttribute(G), (n = !0)), s(n) && k(t, e, f))
                                                )
                                                    return (j(e, f, !0), t);
                        ...
                        ((fo.config.mustUseProp = function (t, e, n) {
                            ...
                            L(fo.options.directives, va),
                            L(fo.options.components, Ia),
                    ...
                    var M = {
                        ...
                        getFishCardImagePath: function (t, e, n) {
                            ...
                            return (
                                (s =
                                    "small" === n
                                        ? ["zh-TW", "zh-CN"].includes(e)
                                            ? "zh-CN"
                                            : "en-US"
                                        : ["zh-TW", "zh-CN", "en-US"].includes(e)
                                          ? e
                                          : "en-US"),
                            ...
                            if (o.GAME_URL) t = o.GAME_URL;
                                ...
                                t =
                                    "webapp" === r.state.device && "IN" === r.state.webId
                                        ...
                                        : "https://" + e.replace("www.", "wbgame.").replace("history.", "wbgame.");
                            }
                            return t;
                        },
                        /**
                        ...
                        formatNumberIDR: function (t) {
                            ...
                            return (
                                i && (r = r.abs()),
                                r.gte(1e9) && a.m
                                    ? ((r = parseFloat(r.div(1e9).toFixed(e, 0))), (o = "M"))
                                    : r.gte(1e6) && a.jt
                                      ? ((r = parseFloat(r.div(1e6).toFixed(e, 0))), (o = "jt"))
                                      : r.gte(1e3) && a.rb && ((r = parseFloat(r.div(1e3).toFixed(e, 0))), (o = "rb")),
                                i && (r *= -1),
                                m(r.toString(), e) + o
                            );
                        },
